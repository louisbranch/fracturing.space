...
Use `campaign_memory_section_read` and `campaign_memory_section_update` to work with individual `## Heading` sections in memory.md without replacing the entire document. This is safer and more efficient than rewriting the full file each turn.
