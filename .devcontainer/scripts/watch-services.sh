...
export FRACTURING_SPACE_WEB2_HTTP_ADDR="${FRACTURING_SPACE_WEB2_HTTP_ADDR:-0.0.0.0:8092}"
export FRACTURING_SPACE_WEBAUTHN_RP_ORIGINS="${FRACTURING_SPACE_WEBAUTHN_RP_ORIGINS:-http://localhost:8080,http://localhost:8092}"
