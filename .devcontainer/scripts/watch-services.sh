...
export FRACTURING_SPACE_ADMIN_INVITE_ADDR="${FRACTURING_SPACE_ADMIN_INVITE_ADDR:-localhost:8095}"
...
export FRACTURING_SPACE_USERHUB_INVITE_ADDR="${FRACTURING_SPACE_USERHUB_INVITE_ADDR:-localhost:8095}"
...
export FRACTURING_SPACE_WORKER_INVITE_ADDR="${FRACTURING_SPACE_WORKER_INVITE_ADDR:-localhost:8095}"
...
export FRACTURING_SPACE_INVITE_PORT="${FRACTURING_SPACE_INVITE_PORT:-8095}"
export FRACTURING_SPACE_INVITE_ADDR="${FRACTURING_SPACE_INVITE_ADDR:-localhost:8095}"
export FRACTURING_SPACE_INVITE_GAME_ADDR="${FRACTURING_SPACE_INVITE_GAME_ADDR:-localhost:8082}"
export FRACTURING_SPACE_INVITE_AUTH_ADDR="${FRACTURING_SPACE_INVITE_AUTH_ADDR:-localhost:8083}"
...
start_service invite
wait_for_service_log_marker "invite" "invite server listening at"
