...
Fracturing.Space is an open-source, server-authoritative engine for tabletop RPG campaigns modeled as deterministic, event-sourced state machines. It exposes gRPC APIs for gameplay and AI orchestration.
...
- AI orchestration tools/resources: [docs/reference/ai-tools.md](docs/reference/ai-tools.md)
