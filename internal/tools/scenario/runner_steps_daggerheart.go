...
func (r *Runner) runAdversaryStep(ctx context.Context, state *scenarioState, step Step) error {
	...
	return r.requireDaggerheartEventTypesAfterSeq(ctx, state, before, daggerheartpayload.EventTypeAdversaryCreated)
}
...
func (r *Runner) runReactionStep(ctx context.Context, state *scenarioState, step Step) error {
	...
	if err := r.requireDaggerheartEventTypesAfterSeq(ctx, state, before, action.EventTypeOutcomeApplied); err != nil {
		return err
	}
...
func (r *Runner) runGroupReactionStep(ctx context.Context, state *scenarioState, step Step) error {
	...
	for index, targetName := range targetNames {
		...
		if appliedDamage > 0 {
			...
			if err := r.requireDaggerheartEventTypesAfterSeq(ctx, state, beforeDamage, daggerheartpayload.EventTypeDamageApplied); err != nil {
				return err
			}
		}
	}
...
func (r *Runner) runGMSpendFearStep(ctx context.Context, state *scenarioState, step Step) error {
	...
	if err := r.requireDaggerheartEventTypesAfterSeq(
		...
		state,
		before,
		daggerheartpayload.EventTypeGMMoveApplied,
...
func (r *Runner) runSetSpotlightStep(ctx context.Context, state *scenarioState, step Step) error {
	...
	if err := r.requireEventTypesAfterSeq(ctx, state, before, session.EventTypeSpotlightSet); err != nil {
		return err
	}
...
func (r *Runner) runClearSpotlightStep(ctx context.Context, state *scenarioState, step Step) error {
	...
	if err := r.requireEventTypesAfterSeq(ctx, state, before, session.EventTypeSpotlightCleared); err != nil {
		return err
	}
	return r.assertExpectedSpotlight(ctx, state, step.Args)
}
...
func (r *Runner) runApplyConditionStep(ctx context.Context, state *scenarioState, step Step) error {
	...
	if characterErr == nil {
		...
		if len(add) > 0 || len(remove) > 0 {
			converted, err := convertDaggerheartEventTypes(daggerheartpayload.EventTypeConditionChanged)
			if err != nil {
				return err
			}
		...
		if lifeState != "" {
			converted, err := convertDaggerheartEventTypes(daggerheartpayload.EventTypeCharacterStatePatched)
			if err != nil {
				return err
			}
			eventTypes = append(eventTypes, converted...)
	...
	return r.requireDaggerheartEventTypesAfterSeq(ctx, state, before, daggerheartpayload.EventTypeAdversaryConditionChanged)
}
...
func (r *Runner) runTemporaryArmorStep(ctx context.Context, state *scenarioState, step Step) error {
	...
	if err := r.requireDaggerheartEventTypesAfterSeq(ctx, state, before, daggerheartpayload.EventTypeCharacterTemporaryArmorApplied); err != nil {
		return err
	}
	return r.assertExpectedDeltas(ctx, state, expectedSpec, expectedBefore)
}
...
func (r *Runner) runRestStep(ctx context.Context, state *scenarioState, step Step) error {
	...
	expectedEvents := []any{daggerheartpayload.EventTypeRestTaken}
...
func (r *Runner) runBlazeOfGloryStep(ctx context.Context, state *scenarioState, step Step) error {
	...
	return r.requireAnyEventTypesAfterSeq(ctx, state, before, character.EventTypeDeleted)
}
...
func (r *Runner) runAttackStep(ctx context.Context, state *scenarioState, step Step) error {
	...
	if !targetIsAdversary {
		...
		if response.GetDamageApplied() != nil {
			if err := r.requireDaggerheartEventTypesAfterSeq(ctx, state, before, daggerheartpayload.EventTypeDamageApplied); err != nil {
				return err
			}
	...
	if attackOutcome.GetResult() != nil && attackOutcome.GetResult().GetSuccess() {
		...
		if applied {
			if err := r.requireDaggerheartEventTypesAfterSeq(ctx, state, before, daggerheartpayload.EventTypeAdversaryDamageApplied); err != nil {
				return err
			}
		}
	}
...
func (r *Runner) runAdversaryAttackStep(ctx context.Context, state *scenarioState, step Step) error {
	...
	if err := r.requireDaggerheartEventTypesAfterSeq(ctx, state, before, action.EventTypeRollResolved); err != nil {
		return err
	}
...
func (r *Runner) runAdversaryReactionStep(ctx context.Context, state *scenarioState, step Step) error {
	...
	if optionalBool(step.Args, "refresh", false) {
		...
		return r.requireDaggerheartEventTypesAfterSeq(ctx, state, before, daggerheartpayload.EventTypeAdversaryUpdated)
	}
	...
	if err := r.requireDaggerheartEventTypesAfterSeq(ctx, state, before, daggerheartpayload.EventTypeAdversaryUpdated); err != nil {
		return err
	}
	return nil
}
...
func (r *Runner) runSwapLoadoutStep(ctx context.Context, state *scenarioState, step Step) error {
	...
	return r.requireDaggerheartEventTypesAfterSeq(ctx, state, before, daggerheartpayload.EventTypeLoadoutSwapped)
}
...
func (r *Runner) runActionRollStep(ctx context.Context, state *scenarioState, step Step) error {
	...
	if err := r.requireEventTypesAfterSeq(ctx, state, before, action.EventTypeRollResolved); err != nil {
		return err
	}
	return r.assertExpectedDeltas(ctx, state, expectedSpec, expectedBefore)
}
...
func (r *Runner) runReactionRollStep(ctx context.Context, state *scenarioState, step Step) error {
	...
	if actorIDValue, err := actorID(state, actorName); err == nil {
		...
		return r.requireEventTypesAfterSeq(ctx, state, before, action.EventTypeRollResolved)
	}
...
func (r *Runner) runDamageRollStep(ctx context.Context, state *scenarioState, step Step) error {
	...
	return r.requireDaggerheartEventTypesAfterSeq(ctx, state, before, action.EventTypeRollResolved)
}
...
func (r *Runner) runApplyRollOutcomeStep(ctx context.Context, state *scenarioState, step Step) error {
	...
	return r.requireAnyEventTypesAfterSeq(ctx, state, before, action.EventTypeOutcomeApplied, action.EventTypeOutcomeRejected)
}
