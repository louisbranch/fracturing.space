...
func registerCampaignTools(
	...
	mcp.AddTool(mcpServer, domain.ParticipantCreateTool(), domain.ParticipantCreateHandler(participantClient, notify))
	mcp.AddTool(mcpServer, domain.ParticipantUpdateTool(), domain.ParticipantUpdateHandler(participantClient, notify))
	mcp.AddTool(mcpServer, domain.ParticipantDeleteTool(), domain.ParticipantDeleteHandler(participantClient, notify))
