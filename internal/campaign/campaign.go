...
// Service implements the CampaignService gRPC API.
type Service struct {
...
// New creates a Service with default dependencies.
func New(store storage.CampaignStore, participantStore storage.ParticipantStore) *Service {
	return &Service{
		store:            store,
...
func (s *Service) CreateCampaign(ctx context.Context, in *campaignv1.CreateCampaignRequest) (*campaignv1.CreateCampaignResponse, error) {
	if in == nil {
...
func (s *Service) ListCampaigns(ctx context.Context, in *campaignv1.ListCampaignsRequest) (*campaignv1.ListCampaignsResponse, error) {
	if in == nil {
