// Package session provides session lifecycle and event management.
package session
...
var (
	...
	ErrEmptyCampaignID = apperrors.New(apperrors.CodeSessionEmptyCampaignID, "campaign id is required")
)
