...
func TestCreateCampaignNilRequest(t *testing.T) {
	service := New(&fakeCampaignStore{}, &fakeParticipantStore{})
...
func TestListCampaignsDefaults(t *testing.T) {
	...
	service := New(store, &fakeParticipantStore{})
...
func TestListCampaignsStoreFailure(t *testing.T) {
	service := New(&fakeCampaignStore{listErr: errors.New("boom")}, &fakeParticipantStore{})
