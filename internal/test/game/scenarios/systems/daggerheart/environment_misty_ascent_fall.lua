...
dh:scene_countdown_create{ name = "Fall Impact", kind = "consequence", current = 0, max = 4, direction = "increase" }
...
dh:apply_roll_outcome{
  on_failure_fear = {
    {kind = "scene_countdown_update", name = "Fall Impact", delta = 1, reason = "failed_save"},
  },
}
