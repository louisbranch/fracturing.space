...
dh:apply_roll_outcome{
  on_critical = {
    {kind = "scene_countdown_update", name = "Misty Ascent", delta = 3, reason = "critical_progress"},
  },
  on_success_hope = {
    {kind = "scene_countdown_update", name = "Misty Ascent", delta = 2, reason = "hopeful_progress"},
  },
  on_success_fear = {
    {kind = "scene_countdown_update", name = "Misty Ascent", delta = 1, reason = "tense_progress"},
  },
}
