...
dh:scene_countdown_create{ name = "Bruinen Ford Crossing", kind = "progress", current = 0, max = 4, direction = "increase" }
dh:action_roll{ actor = "Frodo", trait = "agility", difficulty = 10, outcome = "failure_fear" }
dh:apply_roll_outcome{
  on_success = {
    {kind = "scene_countdown_update", name = "Bruinen Ford Crossing", delta = 1, reason = "crossing_progress"},
  },
  on_failure_fear = {
