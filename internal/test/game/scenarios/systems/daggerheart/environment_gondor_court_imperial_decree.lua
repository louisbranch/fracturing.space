...
dh:countdown_create{ name = "Imperial Agenda", kind = "long_term", current = 0, max = 8, direction = "increase" }
dh:countdown_update{ name = "Imperial Agenda", delta = 2, reason = "imperial_decree_d4_proxy" }
