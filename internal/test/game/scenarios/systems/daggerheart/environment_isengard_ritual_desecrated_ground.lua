...
dh:scene_countdown_create{ name = "Cleanse Desecration", kind = "progress", current = 0, max = 6, direction = "increase" }
dh:action_roll{ actor = "Frodo", trait = "instinct", difficulty = 14, outcome = "success_hope" }
dh:apply_roll_outcome{
  on_success = {
    {kind = "scene_countdown_update", name = "Cleanse Desecration", delta = 1, reason = "cleansing_progress"},
  },
}
