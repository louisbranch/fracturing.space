...
dh:scene_countdown_create{ name = "Chaos Traverse", kind = "progress", current = 0, max = 8, direction = "increase" }
dh:action_roll{ actor = "Frodo", trait = "agility", difficulty = 20, outcome = "success_fear" }
dh:apply_roll_outcome{
  on_success = {
    {kind = "scene_countdown_update", name = "Chaos Traverse", delta = 1, reason = "navigate_shift"},
  },
}
