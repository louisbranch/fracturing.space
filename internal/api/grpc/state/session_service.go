...
// SessionService implements the state.v1.SessionService gRPC API.
...
func (s *SessionService) StartSession(ctx context.Context, in *statev1.StartSessionRequest) (*statev1.StartSessionResponse, error) {
	if in == nil {
...
func (s *SessionService) ListSessions(ctx context.Context, in *statev1.ListSessionsRequest) (*statev1.ListSessionsResponse, error) {
	if in == nil {
	...
	response.Sessions = make([]*statev1.Session, 0, len(page.Sessions))
...
func (s *SessionService) GetSession(ctx context.Context, in *statev1.GetSessionRequest) (*statev1.GetSessionResponse, error) {
	if in == nil {
	...
	return &statev1.GetSessionResponse{
		Session: sessionToProto(sess),
	}, nil
}

// EndSession ends a session by campaign ID and session ID.
func (s *SessionService) EndSession(ctx context.Context, in *statev1.EndSessionRequest) (*statev1.EndSessionResponse, error) {
	if in == nil {
