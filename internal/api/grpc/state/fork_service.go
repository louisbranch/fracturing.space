...
import (
	...
	"github.com/louisbranch/fracturing.space/internal/state/fork"
...
// ForkService implements the state.v1.ForkService gRPC API.
type ForkService struct {
	statev1.UnimplementedForkServiceServer
	stores      Stores
...
func (s *ForkService) ForkCampaign(ctx context.Context, in *statev1.ForkCampaignRequest) (*statev1.ForkCampaignResponse, error) {
	if in == nil {
	...
	return &statev1.ForkCampaignResponse{
...
func (s *ForkService) GetLineage(ctx context.Context, in *statev1.GetLineageRequest) (*statev1.GetLineageResponse, error) {
	if in == nil {
	...
	return &statev1.GetLineageResponse{
		Lineage: &statev1.Lineage{
...
func (s *ForkService) ListForks(ctx context.Context, in *statev1.ListForksRequest) (*statev1.ListForksResponse, error) {
	if in == nil {
...
func forkPointFromProto(pb *statev1.ForkPoint) fork.ForkPoint {
	if pb == nil {
