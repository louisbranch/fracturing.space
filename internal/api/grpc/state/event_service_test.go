...
func TestListEvents_MissingEventStore(t *testing.T) {
	svc := NewEventService(Stores{})
	_, err := svc.ListEvents(context.Background(), &statev1.ListEventsRequest{CampaignId: "c1"})
...
func TestListEvents_MissingCampaignId(t *testing.T) {
	...
	_, err := svc.ListEvents(context.Background(), &statev1.ListEventsRequest{})
	assertStatusCode(t, err, codes.InvalidArgument)
}
...
func TestListEvents_EmptyResult(t *testing.T) {
	...
	resp, err := svc.ListEvents(context.Background(), &statev1.ListEventsRequest{
		CampaignId: "c1",
	})
	if err != nil {
...
func TestListEvents_ASC_Pagination(t *testing.T) {
	...
	resp2, err := svc.ListEvents(context.Background(), &statev1.ListEventsRequest{
		CampaignId: "c1",
		PageSize:   2,
	...
	respBack, err := svc.ListEvents(context.Background(), &statev1.ListEventsRequest{
		CampaignId: "c1",
		PageSize:   2,
