...
// CharacterService implements the state.v1.CharacterService gRPC API.
...
func (s *CharacterService) CreateCharacter(ctx context.Context, in *statev1.CreateCharacterRequest) (*statev1.CreateCharacterResponse, error) {
	if in == nil {
...
func (s *CharacterService) UpdateCharacter(ctx context.Context, in *statev1.UpdateCharacterRequest) (*statev1.UpdateCharacterResponse, error) {
	if in == nil {
	...
	if in.GetKind() != statev1.CharacterKind_CHARACTER_KIND_UNSPECIFIED {
		kind := characterKindFromProto(in.GetKind())
	...
	return &statev1.UpdateCharacterResponse{Character: characterToProto(updated)}, nil
}

// DeleteCharacter deletes a character.
func (s *CharacterService) DeleteCharacter(ctx context.Context, in *statev1.DeleteCharacterRequest) (*statev1.DeleteCharacterResponse, error) {
	if in == nil {
	...
	return &statev1.DeleteCharacterResponse{Character: characterToProto(ch)}, nil
}

// ListCharacters returns a page of character records for a campaign.
func (s *CharacterService) ListCharacters(ctx context.Context, in *statev1.ListCharactersRequest) (*statev1.ListCharactersResponse, error) {
	if in == nil {
	...
	response.Characters = make([]*statev1.Character, 0, len(page.Characters))
...
func (s *CharacterService) SetDefaultControl(ctx context.Context, in *statev1.SetDefaultControlRequest) (*statev1.SetDefaultControlResponse, error) {
	if in == nil {
	...
	return &statev1.SetDefaultControlResponse{
		CampaignId:  campaignID,
		CharacterId: characterID,
...
func (s *CharacterService) GetCharacterSheet(ctx context.Context, in *statev1.GetCharacterSheetRequest) (*statev1.GetCharacterSheetResponse, error) {
	if in == nil {
...
func (s *CharacterService) PatchCharacterProfile(ctx context.Context, in *statev1.PatchCharacterProfileRequest) (*statev1.PatchCharacterProfileResponse, error) {
	if in == nil {
	...
	return &statev1.PatchCharacterProfileResponse{
		Profile: daggerheartProfileToProto(campaignID, characterID, dhProfile),
	}, nil
}

// daggerheartProfileToProto converts a Daggerheart profile to proto.
func daggerheartProfileToProto(campaignID, characterID string, dh storage.DaggerheartCharacterProfile) *statev1.CharacterProfile {
...
func daggerheartStateToProto(campaignID, characterID string, dh storage.DaggerheartCharacterState) *statev1.CharacterState {
	return &statev1.CharacterState{
		CampaignId:  campaignID,
		CharacterId: characterID,
