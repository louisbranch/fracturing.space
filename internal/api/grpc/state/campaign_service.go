...
// CampaignService implements the state.v1.CampaignService gRPC API.
...
func (s *CampaignService) CreateCampaign(ctx context.Context, in *statev1.CreateCampaignRequest) (*statev1.CreateCampaignResponse, error) {
	if in == nil {
...
func (s *CampaignService) ListCampaigns(ctx context.Context, in *statev1.ListCampaignsRequest) (*statev1.ListCampaignsResponse, error) {
	if in == nil {
	...
	response.Campaigns = make([]*statev1.Campaign, 0, len(page.Campaigns))
...
func (s *CampaignService) GetCampaign(ctx context.Context, in *statev1.GetCampaignRequest) (*statev1.GetCampaignResponse, error) {
	if in == nil {
	...
	return &statev1.GetCampaignResponse{
		Campaign: campaignToProto(c),
	}, nil
}

// EndCampaign marks a campaign as completed.
func (s *CampaignService) EndCampaign(ctx context.Context, in *statev1.EndCampaignRequest) (*statev1.EndCampaignResponse, error) {
	if in == nil {
	...
	return &statev1.EndCampaignResponse{Campaign: campaignToProto(updated)}, nil
}

// ArchiveCampaign archives a campaign.
func (s *CampaignService) ArchiveCampaign(ctx context.Context, in *statev1.ArchiveCampaignRequest) (*statev1.ArchiveCampaignResponse, error) {
	if in == nil {
	...
	return &statev1.ArchiveCampaignResponse{Campaign: campaignToProto(updated)}, nil
}

// RestoreCampaign restores an archived campaign to draft state.
func (s *CampaignService) RestoreCampaign(ctx context.Context, in *statev1.RestoreCampaignRequest) (*statev1.RestoreCampaignResponse, error) {
	if in == nil {
	...
	return &statev1.RestoreCampaignResponse{Campaign: campaignToProto(updated)}, nil
}
