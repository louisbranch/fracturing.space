...
describe("OnStagePanel", () => {
  it("renders the on-stage scene card, GM interaction card, slot list, and compose regions", () => {
    ...
    expect(scrollRegion).toContainElement(screen.getByLabelText("On-stage GM interaction"));
  ...
  it("shows the OOC-blocked state as informational and non-actionable", () => {
    ...
    expect(screen.getByLabelText("On-stage interaction status: OOC Open")).toBeInTheDocument();
