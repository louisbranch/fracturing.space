...
import (
	...
	"github.com/louisbranch/fracturing.space/internal/services/web2/platform/i18n"
)
...
func BuildRootHandler(cfg Config, authRequired func(*http.Request) bool) (http.Handler, error) {
	...
	// TODO(web2-composition): consider fail-fast startup checks for required resolver seams; implicit defaults can hide missing wiring.
