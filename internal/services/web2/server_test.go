...
func TestExperimentalCampaignMutationRouteRejectsMemberAccess(t *testing.T) {
	...
	h, err := NewHandler(Config{
		...
		ParticipantClient: fakeWeb2ParticipantClient{response: &statev1.ListParticipantsResponse{Participants: []*statev1.Participant{{
			Id:             "p-member",
			CampaignId:     "c1",
			UserId:         "user-1",
...
func TestUnknownRootRouteRendersNotFoundPage(t *testing.T) {
	...
	h, err := NewHandler(Config{AuthClient: newFakeWeb2AuthClient()})
	if err != nil {
		t.Fatalf("NewHandler() error = %v", err)
	}
...
func TestNewHandlerResolvesCookieSessionAtMostOncePerRequest(t *testing.T) {
	...
	auth := newCountingWeb2AuthClient()
...
func TestNewServerBuildsHTTPServer(t *testing.T) {
	...
	srv, err := NewServer(context.Background(), Config{HTTPAddr: "127.0.0.1:0", AuthClient: newFakeWeb2AuthClient()})
	if err != nil {
...
func TestListenAndServeRejectsNilServer(t *testing.T) {
	...
	if !strings.Contains(err.Error(), "web2 server is nil") {
...
func TestListenAndServeReturnsServeError(t *testing.T) {
	...
	if !strings.Contains(err.Error(), "serve web2 http") {
...
func attachSessionCookie(t *testing.T, req *http.Request, auth *fakeWeb2AuthClient, userID string) {
	t.Helper()
	if req == nil {
	...
	req.AddCookie(&http.Cookie{Name: "web2_session", Value: sessionID})
}

func defaultProtectedConfig(auth *fakeWeb2AuthClient) Config {
	return Config{
		EnableExperimentalModules: true,
		AuthClient:                auth,
		CampaignClient:            defaultCampaignClient(),
...
func defaultStableProtectedConfig(auth *fakeWeb2AuthClient) Config {
	return Config{
...
func defaultParticipantClient() fakeWeb2ParticipantClient {
	return fakeWeb2ParticipantClient{response: &statev1.ListParticipantsResponse{Participants: []*statev1.Participant{{
		Id:             "p1",
		CampaignId:     "c1",
		UserId:         "user-1",
		Name:           "Owner",
...
func defaultCharacterClient() fakeWeb2CharacterClient {
	return fakeWeb2CharacterClient{response: &statev1.ListCharactersResponse{Characters: []*statev1.Character{{
		Id:   "char-1",
		Name: "Aria",
...
func defaultSessionClient() fakeWeb2SessionClient {
	return fakeWeb2SessionClient{response: &statev1.ListSessionsResponse{Sessions: []*statev1.Session{{
		Id:     "sess-1",
		Name:   "Session One",
...
func defaultInviteClient() fakeWeb2InviteClient {
	return fakeWeb2InviteClient{response: &statev1.ListInvitesResponse{Invites: []*statev1.Invite{{
		Id:              "inv-1",
		CampaignId:      "c1",
		ParticipantId:   "p1",
...
type fakeWeb2ParticipantClient struct {
	response *statev1.ListParticipantsResponse
	err      error
}

func (f fakeWeb2ParticipantClient) ListParticipants(context.Context, *statev1.ListParticipantsRequest, ...grpc.CallOption) (*statev1.ListParticipantsResponse, error) {
	if f.err != nil {
		return nil, f.err
	}
	if f.response != nil {
...
type fakeWeb2CharacterClient struct {
	response *statev1.ListCharactersResponse
	err      error
}

func (f fakeWeb2CharacterClient) ListCharacters(context.Context, *statev1.ListCharactersRequest, ...grpc.CallOption) (*statev1.ListCharactersResponse, error) {
	if f.err != nil {
		return nil, f.err
	}
	if f.response != nil {
...
type fakeWeb2SessionClient struct {
	response *statev1.ListSessionsResponse
	err      error
}

func (f fakeWeb2SessionClient) ListSessions(context.Context, *statev1.ListSessionsRequest, ...grpc.CallOption) (*statev1.ListSessionsResponse, error) {
	if f.err != nil {
		return nil, f.err
	}
	if f.response != nil {
...
type fakeWeb2InviteClient struct {
	response *statev1.ListInvitesResponse
	err      error
}

func (f fakeWeb2InviteClient) ListInvites(context.Context, *statev1.ListInvitesRequest, ...grpc.CallOption) (*statev1.ListInvitesResponse, error) {
	if f.err != nil {
		return nil, f.err
	}
	if f.response != nil {
...
type fakeWeb2AuthClient struct {
	mu       sync.Mutex
	sessions map[string]string
}

type countingWeb2AuthClient struct {
	*fakeWeb2AuthClient
	countMu            sync.Mutex
	getWebSessionCalls int
}

func newCountingWeb2AuthClient() *countingWeb2AuthClient {
	return &countingWeb2AuthClient{fakeWeb2AuthClient: newFakeWeb2AuthClient()}
}

func (f *countingWeb2AuthClient) GetWebSession(ctx context.Context, req *authv1.GetWebSessionRequest, opts ...grpc.CallOption) (*authv1.GetWebSessionResponse, error) {
	f.countMu.Lock()
	f.getWebSessionCalls++
	f.countMu.Unlock()
	return f.fakeWeb2AuthClient.GetWebSession(ctx, req, opts...)
}

func (f *countingWeb2AuthClient) GetWebSessionCalls() int {
	f.countMu.Lock()
	defer f.countMu.Unlock()
	return f.getWebSessionCalls
}

func newFakeWeb2AuthClient() *fakeWeb2AuthClient {
	return &fakeWeb2AuthClient{sessions: map[string]string{}}
}

func (f *fakeWeb2AuthClient) CreateUser(context.Context, *authv1.CreateUserRequest, ...grpc.CallOption) (*authv1.CreateUserResponse, error) {
	return &authv1.CreateUserResponse{User: &authv1.User{Id: "user-1"}}, nil
}

func (f *fakeWeb2AuthClient) BeginPasskeyRegistration(context.Context, *authv1.BeginPasskeyRegistrationRequest, ...grpc.CallOption) (*authv1.BeginPasskeyRegistrationResponse, error) {
	return &authv1.BeginPasskeyRegistrationResponse{SessionId: "register-session", CredentialCreationOptionsJson: []byte(`{"publicKey":{"challenge":"ZmFrZQ","rp":{"name":"web2"},"user":{"id":"dXNlcg","name":"new@example.com","displayName":"new@example.com"},"pubKeyCredParams":[{"type":"public-key","alg":-7}]}}`)}, nil
}

func (f *fakeWeb2AuthClient) FinishPasskeyRegistration(context.Context, *authv1.FinishPasskeyRegistrationRequest, ...grpc.CallOption) (*authv1.FinishPasskeyRegistrationResponse, error) {
	return &authv1.FinishPasskeyRegistrationResponse{User: &authv1.User{Id: "user-1"}}, nil
}

func (f *fakeWeb2AuthClient) BeginPasskeyLogin(context.Context, *authv1.BeginPasskeyLoginRequest, ...grpc.CallOption) (*authv1.BeginPasskeyLoginResponse, error) {
...
func (f *fakeWeb2AuthClient) FinishPasskeyLogin(context.Context, *authv1.FinishPasskeyLoginRequest, ...grpc.CallOption) (*authv1.FinishPasskeyLoginResponse, error) {
	return &authv1.FinishPasskeyLoginResponse{User: &authv1.User{Id: "user-1"}}, nil
}

func (f *fakeWeb2AuthClient) CreateWebSession(_ context.Context, req *authv1.CreateWebSessionRequest, _ ...grpc.CallOption) (*authv1.CreateWebSessionResponse, error) {
	f.mu.Lock()
	defer f.mu.Unlock()
	id := "ws-1"
...
func (f *fakeWeb2AuthClient) GetWebSession(_ context.Context, req *authv1.GetWebSessionRequest, _ ...grpc.CallOption) (*authv1.GetWebSessionResponse, error) {
	f.mu.Lock()
	defer f.mu.Unlock()
...
func (f *fakeWeb2AuthClient) RevokeWebSession(_ context.Context, req *authv1.RevokeWebSessionRequest, _ ...grpc.CallOption) (*authv1.RevokeWebSessionResponse, error) {
	f.mu.Lock()
	defer f.mu.Unlock()
