...
var errorPageTitleTextKeys = map[string]string{
	...
	"Username settings unavailable":  "error.web.title.username_settings_unavailable",
...
var errorPageMessageTextKeys = map[string]string{
	...
	"failed to parse username form":                           "error.web.message.failed_to_parse_username_form",
	...
	"failed to load username":                                 "error.web.message.failed_to_load_username",
