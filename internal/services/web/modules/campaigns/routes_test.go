...
func TestRegisterStableRoutesExposeWorkspaceAndMutationRoutes(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "participant delete", method: http.MethodPost, path: routepath.AppCampaignParticipantDelete("c1", "p-1"), body: "", wantStatus: http.StatusFound},
		...
		{name: "participant delete submit", method: http.MethodPost, path: routepath.AppCampaignParticipantDelete("c1", "p-1"), body: "", wantStatus: http.StatusFound},
