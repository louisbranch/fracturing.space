...
func TestPublicAuthSurfaceServicesStaySplitEndToEnd(t *testing.T) {
	...
	assertTypeExists(t, "publicauth/app/service_page.go", "pageService")
	assertTypeExists(t, "publicauth/app/service_session.go", "sessionService")
	assertTypeExists(t, "publicauth/app/service_passkey.go", "passkeyService")
	assertTypeExists(t, "publicauth/app/service_recovery.go", "recoveryService")
	assertFuncExists(t, "publicauth/app/service_page.go", "NewPageService")
	assertFuncExists(t, "publicauth/app/service_session.go", "NewSessionService")
	assertFuncExists(t, "publicauth/app/service_passkey.go", "NewPasskeyService")
	assertFuncExists(t, "publicauth/app/service_recovery.go", "NewRecoveryService")
	assertFuncMissing(t, "publicauth/app/service_page.go", "NewService")
	assertFuncMissing(t, "publicauth/app/service_session.go", "NewService")
	assertFuncMissing(t, "publicauth/app/service_passkey.go", "NewService")
	assertFuncMissing(t, "publicauth/app/service_recovery.go", "NewService")
...
func TestPublicAuthUsesSharedRedirectAndPrincipalSeams(t *testing.T) {
	...
	assertFileCallsSelector(t, "publicauth/app/service_helpers.go", "redirectpath", "ResolveSafe")
