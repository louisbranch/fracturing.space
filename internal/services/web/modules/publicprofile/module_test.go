...
func TestMountServesPublicProfilePage(t *testing.T) {
	t.Parallel()

	mount := mountPublicProfileModule(t, module.Dependencies{
...
func TestMountReturnsNotFoundForNestedPath(t *testing.T) {
	...
	mount := mountPublicProfileModule(t, module.Dependencies{SocialClient: &socialClientStub{}})
...
func mountPublicProfileModule(t *testing.T, deps module.Dependencies) module.Mount {
	t.Helper()
