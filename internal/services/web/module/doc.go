...
// composition and area-owned modules.
//
...
//   - Module and Mount define the only transport contract that composition
//     relies on,
...
// in principal/, composition/, or the owning module package instead.
package module
