...
type Handlers struct {
	...
	CampaignOverview          moduleruntime.StringParamHandler
	CampaignSessions          moduleruntime.StringParamHandler
	CampaignSessionStart      moduleruntime.StringParamHandler
	CampaignSessionEnd        moduleruntime.StringParamHandler
	CampaignSessionDetail     PairParamHandler
	CampaignParticipants      moduleruntime.StringParamHandler
	CampaignParticipantUpdate moduleruntime.StringParamHandler
	CampaignCharacters        moduleruntime.StringParamHandler
	CampaignCharacterCreate   moduleruntime.StringParamHandler
	CampaignCharacterUpdate   moduleruntime.StringParamHandler
	CampaignCharacterControl  moduleruntime.StringParamHandler
	CampaignCharacterDetail   PairParamHandler
	CampaignInvites           moduleruntime.StringParamHandler
	CampaignInviteCreate      moduleruntime.StringParamHandler
	CampaignInviteRevoke      moduleruntime.StringParamHandler
}
...
func (s callbackService) HandleCampaignInvites(w http.ResponseWriter, r *http.Request, campaignID string) {
	moduleruntime.CallStringOrNotFound(w, r, s.handlers.CampaignInvites, campaignID)
}

func (s callbackService) HandleCampaignInviteCreate(w http.ResponseWriter, r *http.Request, campaignID string) {
	moduleruntime.CallStringOrNotFound(w, r, s.handlers.CampaignInviteCreate, campaignID)
}

func (s callbackService) HandleCampaignInviteRevoke(w http.ResponseWriter, r *http.Request, campaignID string) {
	moduleruntime.CallStringOrNotFound(w, r, s.handlers.CampaignInviteRevoke, campaignID)
}
