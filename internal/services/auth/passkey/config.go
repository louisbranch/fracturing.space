...
type Config struct {
	...
	SignupSessionTTL time.Duration `env:"FRACTURING_SPACE_WEBAUTHN_SIGNUP_SESSION_TTL"    envDefault:"2m"`
}
...
func LoadConfigFromEnv() Config {
	...
	if cfg.SignupSessionTTL == 0 {
		cfg.SignupSessionTTL = 2 * time.Minute
	}
	return cfg
}
