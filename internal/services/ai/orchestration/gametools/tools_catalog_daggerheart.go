		...
		},
		{
			Tool: orchestration.Tool{
				...
				InputSchema: schemaObject(map[string]schemaProperty{
					...
					"hope_spends":               {Type: "array", Description: "optional explicit Hope spends declared for this roll", Items: &schemaProperty{Type: "object", Properties: map[string]schemaProperty{"source": {Type: "string", Description: "Hope spend source, such as experience or help"}, "amount": {Type: "integer", Description: "Hope amount for that source"}}}},
		...
		},
		{
			Tool: orchestration.Tool{
				...
				InputSchema: schemaObject(map[string]schemaProperty{
					...
					"leader_hope_spends":  {Type: "array", Description: "optional explicit Hope spends declared for the leader roll", Items: &schemaProperty{Type: "object", Properties: map[string]schemaProperty{"source": {Type: "string", Description: "Hope spend source, such as experience or tag_team"}, "amount": {Type: "integer", Description: "Hope amount for that source"}}}},
			...
			Tool: orchestration.Tool{
				...
				InputSchema: schemaObject(map[string]schemaProperty{
					"first": {Type: "object", Description: "first tag-team participant", Properties: map[string]schemaProperty{
						...
						"hope_spends":  {Type: "array", Description: "optional explicit Hope spends declared for the first participant roll", Items: &schemaProperty{Type: "object", Properties: map[string]schemaProperty{"source": {Type: "string", Description: "Hope spend source"}, "amount": {Type: "integer", Description: "Hope amount for that source"}}}},
					...
					"second": {Type: "object", Description: "second tag-team participant", Properties: map[string]schemaProperty{
						...
						"hope_spends":  {Type: "array", Description: "optional explicit Hope spends declared for the second participant roll", Items: &schemaProperty{Type: "object", Properties: map[string]schemaProperty{"source": {Type: "string", Description: "Hope spend source"}, "amount": {Type: "integer", Description: "Hope amount for that source"}}}},
