...
func (a sessionFlowApplication) runSessionDamageRoll(ctx context.Context, in *pb.SessionDamageRollRequest) (*pb.SessionDamageRollResponse, error) {
	if in == nil {
	...
	domainResult, err := a.service.executeAndApplyDomainCommand(ctx, command.Command{
	...
	}, a.service.stores.Applier(), domainCommandApplyOptions{
		requireEvents:   true,
...
func (a sessionFlowApplication) runSessionAttackFlow(ctx context.Context, in *pb.SessionAttackFlowRequest) (*pb.SessionAttackFlowResponse, error) {
	if in == nil {
	...
	rollResp, err := a.service.SessionActionRoll(ctx, &pb.SessionActionRollRequest{
		CampaignId:        campaignID,
		SessionId:         sessionID,
	...
	rollOutcome, err := a.service.ApplyRollOutcome(ctxWithMeta, &pb.ApplyRollOutcomeRequest{
		SessionId: sessionID,
	...
	attackOutcome, err := a.service.ApplyAttackOutcome(ctxWithMeta, &pb.DaggerheartApplyAttackOutcomeRequest{
		SessionId: sessionID,
		RollSeq:   rollResp.GetRollSeq(),
	...
	damageRoll, err := a.service.SessionDamageRoll(ctx, &pb.SessionDamageRollRequest{
		CampaignId:  campaignID,
		SessionId:   sessionID,
		CharacterId: attackerID,
	...
	applyDamage, err := a.service.ApplyDamage(ctxWithMeta, &pb.DaggerheartApplyDamageRequest{
		CampaignId:        campaignID,
...
func (a sessionFlowApplication) runSessionReactionFlow(ctx context.Context, in *pb.SessionReactionFlowRequest) (*pb.SessionReactionFlowResponse, error) {
	if in == nil {
	...
	reactionOutcome, err := a.service.ApplyReactionOutcome(ctxWithMeta, &pb.DaggerheartApplyReactionOutcomeRequest{
		SessionId: sessionID,
		RollSeq:   rollResp.GetRollSeq(),
	})
	if err != nil {
...
func (a sessionFlowApplication) runSessionAdversaryAttackRoll(ctx context.Context, in *pb.SessionAdversaryAttackRollRequest) (*pb.SessionAdversaryAttackRollResponse, error) {
	if in == nil {
	...
	if _, err := a.service.loadAdversaryForSession(ctx, campaignID, sessionID, adversaryID); err != nil {
		return nil, err
	}
...
func (a sessionFlowApplication) runSessionAdversaryActionCheck(ctx context.Context, in *pb.SessionAdversaryActionCheckRequest) (*pb.SessionAdversaryActionCheckResponse, error) {
	if in == nil {
...
func (a sessionFlowApplication) runSessionAdversaryAttackFlow(ctx context.Context, in *pb.SessionAdversaryAttackFlowRequest) (*pb.SessionAdversaryAttackFlowResponse, error) {
	if in == nil {
	...
	rollResp, err := a.service.SessionAdversaryAttackRoll(ctx, &pb.SessionAdversaryAttackRollRequest{
		CampaignId:     campaignID,
		SessionId:      sessionID,
	...
	ctxWithMeta := withCampaignSessionMetadata(ctx, campaignID, sessionID)
	attackOutcome, err := a.service.ApplyAdversaryAttackOutcome(ctxWithMeta, &pb.DaggerheartApplyAdversaryAttackOutcomeRequest{
		SessionId:  sessionID,
		RollSeq:    rollResp.GetRollSeq(),
		Targets:    []string{targetID},
		Difficulty: in.GetDifficulty(),
...
func (a sessionFlowApplication) runSessionGroupActionFlow(ctx context.Context, in *pb.SessionGroupActionFlowRequest) (*pb.SessionGroupActionFlowResponse, error) {
	if in == nil {
	...
	leaderRoll, err := a.service.SessionActionRoll(ctx, &pb.SessionActionRollRequest{
		CampaignId:  campaignID,
		SessionId:   sessionID,
	...
	ctxWithMeta := withCampaignSessionMetadata(ctx, campaignID, sessionID)
	leaderOutcome, err := a.service.ApplyRollOutcome(ctxWithMeta, &pb.ApplyRollOutcomeRequest{
		SessionId: sessionID,
...
func (a sessionFlowApplication) runSessionTagTeamFlow(ctx context.Context, in *pb.SessionTagTeamFlowRequest) (*pb.SessionTagTeamFlowResponse, error) {
	if in == nil {
	...
	firstRoll, err := a.service.SessionActionRoll(ctx, &pb.SessionActionRollRequest{
		CampaignId:  campaignID,
		SessionId:   sessionID,
		CharacterId: firstID,
		Trait:       firstTrait,
	...
	secondRoll, err := a.service.SessionActionRoll(ctx, &pb.SessionActionRollRequest{
		CampaignId:  campaignID,
		SessionId:   sessionID,
	...
	selectedOutcome, err := a.service.ApplyRollOutcome(ctxWithMeta, &pb.ApplyRollOutcomeRequest{
		SessionId: sessionID,
