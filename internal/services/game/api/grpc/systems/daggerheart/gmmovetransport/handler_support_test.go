...
func TestHandlerRequireDependencies(t *testing.T) {
	tests := []struct {
		...
		{name: "missing executor", deps: Dependencies{Campaign: testCampaignStore{}, Session: testSessionStore{}, SessionGate: testGateStore{}, Daggerheart: testDaggerheartStore{}}},
	}
