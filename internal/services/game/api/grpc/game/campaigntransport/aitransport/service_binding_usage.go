...
func (s *Service) GetCampaignAIBindingUsage(ctx context.Context, in *campaignv1.GetCampaignAIBindingUsageRequest) (*campaignv1.GetCampaignAIBindingUsageResponse, error) {
	if in == nil {
