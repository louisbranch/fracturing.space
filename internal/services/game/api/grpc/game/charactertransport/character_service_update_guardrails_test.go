...
func TestUpdateCharacter_DeniesMemberWhenNotOwner(t *testing.T) {
	...
	_, err := svc.UpdateCharacter(requestctx.WithParticipantID(context.Background(), "member-1"), &statev1.UpdateCharacterRequest{
		CampaignId:  "c1",
		CharacterId: "ch1",
...
func TestUpdateCharacter_DeniesControllerWhenOwnershipUnresolved(t *testing.T) {
	...
	svc := NewService(ts.withDomain(domain).build())
	_, err := svc.UpdateCharacter(requestctx.WithParticipantID(context.Background(), "controller-1"), &statev1.UpdateCharacterRequest{
		CampaignId:  "c1",
		CharacterId: "ch1",
		Name:        wrapperspb.String("Renamed"),
	})
...
func TestUpdateCharacter_DeniesManagerOwnershipTransfer(t *testing.T) {
	...
	svc := NewService(ts.withDomain(domain).build())
	_, err := svc.UpdateCharacter(requestctx.WithParticipantID(context.Background(), "manager-1"), &statev1.UpdateCharacterRequest{
		CampaignId:         "c1",
		CharacterId:        "ch1",
