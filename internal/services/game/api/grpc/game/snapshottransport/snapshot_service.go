...
// Service implements the game.v1.SnapshotService gRPC API.
type Service struct {
	campaignv1.UnimplementedSnapshotServiceServer
	app snapshotApplication
}

// NewService creates a snapshot Service with default dependencies.
func NewService(deps Deps) *Service {
	return &Service{
		app: newSnapshotApplicationWithDependencies(deps),
	}
}

// GetSnapshot returns the snapshot projection for a campaign.
func (s *Service) GetSnapshot(ctx context.Context, in *campaignv1.GetSnapshotRequest) (*campaignv1.GetSnapshotResponse, error) {
	if in == nil {
...
func (s *Service) PatchCharacterState(ctx context.Context, in *campaignv1.PatchCharacterStateRequest) (*campaignv1.PatchCharacterStateResponse, error) {
	if in == nil {
...
func (s *Service) UpdateSnapshotState(ctx context.Context, in *campaignv1.UpdateSnapshotStateRequest) (*campaignv1.UpdateSnapshotStateResponse, error) {
	if in == nil {
