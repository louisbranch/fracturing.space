...
// InviteToProto converts an invite storage record to a protobuf Invite message.
...
// InviteStatusToProto converts a domain invite status to its protobuf representation.
...
// InviteStatusFromProto converts a protobuf invite status to its domain representation.
