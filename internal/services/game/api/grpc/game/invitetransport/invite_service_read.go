...
func newInviteReadDependencies(deps Deps, authClient authv1.AuthServiceClient) inviteReadDependencies {
...
func (s *Service) GetInvite(ctx context.Context, in *campaignv1.GetInviteRequest) (*campaignv1.GetInviteResponse, error) {
	if in == nil {
...
func (s *Service) GetPublicInvite(ctx context.Context, in *campaignv1.GetPublicInviteRequest) (*campaignv1.GetPublicInviteResponse, error) {
	if in == nil {
...
func (s *Service) ListInvites(ctx context.Context, in *campaignv1.ListInvitesRequest) (*campaignv1.ListInvitesResponse, error) {
	if in == nil {
...
func (s *Service) publicInviteCreatorUser(ctx context.Context, inv storage.InviteRecord) (*authv1.User, bool) {
