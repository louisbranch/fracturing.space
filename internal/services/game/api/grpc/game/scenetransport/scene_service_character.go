...
func (s *Service) AddCharacterToScene(ctx context.Context, in *campaignv1.AddCharacterToSceneRequest) (*campaignv1.AddCharacterToSceneResponse, error) {
	if in == nil {
...
func (s *Service) RemoveCharacterFromScene(ctx context.Context, in *campaignv1.RemoveCharacterFromSceneRequest) (*campaignv1.RemoveCharacterFromSceneResponse, error) {
	if in == nil {
...
func (s *Service) TransferCharacter(ctx context.Context, in *campaignv1.TransferCharacterRequest) (*campaignv1.TransferCharacterResponse, error) {
	if in == nil {
