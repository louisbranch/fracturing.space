...
func (s *Service) SetSceneSpotlight(ctx context.Context, in *campaignv1.SetSceneSpotlightRequest) (*campaignv1.SetSceneSpotlightResponse, error) {
	if in == nil {
...
func (s *Service) ClearSceneSpotlight(ctx context.Context, in *campaignv1.ClearSceneSpotlightRequest) (*campaignv1.ClearSceneSpotlightResponse, error) {
	if in == nil {
