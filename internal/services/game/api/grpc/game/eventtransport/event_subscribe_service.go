...
func (s *Service) SubscribeCampaignUpdates(in *campaignv1.SubscribeCampaignUpdatesRequest, stream grpc.ServerStreamingServer[campaignv1.CampaignUpdate]) error {
	if in == nil {
