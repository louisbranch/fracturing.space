...
func TestListActiveSessionsForUser_ReturnsSortedPage(t *testing.T) {
	...
	resp, err := svc.ListActiveSessionsForUser(contextWithUserID("user-1"), &statev1.ListActiveSessionsForUserRequest{PageSize: 2})
	if err != nil {
...
func TestListActiveSessionsForUser_PropagatesParticipantLookupFailure(t *testing.T) {
	...
	_, err := svc.ListActiveSessionsForUser(contextWithUserID("user-1"), &statev1.ListActiveSessionsForUserRequest{})
