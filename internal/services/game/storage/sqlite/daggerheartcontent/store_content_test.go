...
func TestDaggerheartClassCRUD(t *testing.T) {
	...
	expected := contentstore.DaggerheartClass{
		ID:              "class-warrior",
		Name:            "Warrior",
		StartingEvasion: 8,
		StartingHP:      18,
...
func TestDaggerheartSubclassCRUD(t *testing.T) {
	...
	expected := contentstore.DaggerheartSubclass{
		ID:             "sub-berserker",
...
func TestDaggerheartHeritageCRUD(t *testing.T) {
	...
	expected := contentstore.DaggerheartHeritage{
		ID:   "her-elf",
		Name: "Elf",
		Kind: "ancestry",
		Features: []contentstore.DaggerheartFeature{
...
func TestDaggerheartExperienceCRUD(t *testing.T) {
	...
	expected := contentstore.DaggerheartExperienceEntry{
		ID:          "exp-scholar",
		Name:        "Scholar",
...
func TestDaggerheartAdversaryEntryCRUD(t *testing.T) {
	...
	expected := contentstore.DaggerheartAdversaryEntry{
		ID:              "adv-orc",
		Name:            "Orc Warrior",
		Tier:            2,
		Role:            "bruiser",
		...
		StandardAttack: contentstore.DaggerheartAdversaryAttack{
			Name:        "Greataxe",
			Range:       "melee",
			DamageDice:  []contentstore.DaggerheartDamageDie{{Sides: 8, Count: 2}},
			DamageBonus: 3,
			DamageType:  "physical",
		},
...
func TestDaggerheartBeastformCRUD(t *testing.T) {
	...
	expected := contentstore.DaggerheartBeastformEntry{
		ID:           "beast-wolf",
		Name:         "Dire Wolf",
		Tier:         1,
		Examples:     "Wolf, Dog",
...
func TestDaggerheartCompanionExperienceCRUD(t *testing.T) {
	...
	expected := contentstore.DaggerheartCompanionExperienceEntry{
		ID:          "cexp-loyal",
...
func TestDaggerheartLootEntryCRUD(t *testing.T) {
	...
	expected := contentstore.DaggerheartLootEntry{
		ID:          "loot-gem",
		Name:        "Ruby Gem",
		Roll:        7,
...
func TestDaggerheartDamageTypeCRUD(t *testing.T) {
	...
	expected := contentstore.DaggerheartDamageTypeEntry{
		ID:          "dt-fire",
		Name:        "Fire",
...
func TestDaggerheartDomainCRUD(t *testing.T) {
	...
	expected := contentstore.DaggerheartDomain{
		ID:          "dom-blade",
		Name:        "Blade",
...
func TestDaggerheartDomainCardCRUD(t *testing.T) {
	...
	// Seed a domain first
	if err := store.PutDaggerheartDomain(context.Background(), contentstore.DaggerheartDomain{
		ID: "dom-arcana", Name: "Arcana", CreatedAt: now, UpdatedAt: now,
	}); err != nil {
		t.Fatalf("seed domain: %v", err)
	}

	expected := contentstore.DaggerheartDomainCard{
		ID:          "card-fireball",
		Name:        "Fireball",
		DomainID:    "dom-arcana",
		Level:       3,
	...
	if err := store.PutDaggerheartDomainCard(context.Background(), contentstore.DaggerheartDomainCard{
...
func TestDaggerheartArmorCRUD(t *testing.T) {
	...
	expected := contentstore.DaggerheartArmor{
		ID:                  "arm-chain",
		Name:                "Chain Mail",
		Tier:                2,
...
func TestDaggerheartItemCRUD(t *testing.T) {
	...
	expected := contentstore.DaggerheartItem{
		ID:          "item-potion",
		Name:        "Healing Potion",
		Rarity:      "common",
		Kind:        "consumable",
...
func TestDaggerheartEnvironmentCRUD(t *testing.T) {
	...
	expected := contentstore.DaggerheartEnvironment{
		ID:                    "env-dungeon",
		Name:                  "Dark Dungeon",
		Tier:                  2,
		Type:                  "underground",
...
func TestDaggerheartContentString(t *testing.T) {
	...
	expected := contentstore.DaggerheartContentString{
