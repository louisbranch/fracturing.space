...
func TestDaggerheartCharacterProfilePutGet(t *testing.T) {
	...
	expected := projectionstore.DaggerheartCharacterProfile{
		CampaignID:      "camp-dhp",
		CharacterID:     "char-1",
		Level:           5,
		HpMax:           18,
...
func TestDaggerheartCharacterProfileDelete(t *testing.T) {
	...
	if err := store.PutDaggerheartCharacterProfile(context.Background(), projectionstore.DaggerheartCharacterProfile{
		...
		StressMax:   6,
		Evasion:     10,
		Experiences: []projectionstore.DaggerheartExperience{{Name: "Guard Duty", Modifier: 2}},
	}); err != nil {
		t.Fatalf("put profile: %v", err)
	}
...
func TestDaggerheartCharacterStatePutGet(t *testing.T) {
	...
	expected := projectionstore.DaggerheartCharacterState{
		CampaignID:  "camp-dhs",
		CharacterID: "char-1",
		Hp:          15,
		Hope:        4,
...
func TestDaggerheartSnapshotPutGet(t *testing.T) {
	...
	expected := projectionstore.DaggerheartSnapshot{
