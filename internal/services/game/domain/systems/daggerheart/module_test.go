...
func commandValidationCases() []commandValidationCase {
	return []commandValidationCase{
		...
		{typ: daggerheartdecider.CommandTypeSceneCountdownAdvance, validPayload: `{"countdown_id":"cd-1","before_remaining":2,"after_remaining":1,"advanced_by":1,"status_before":"active","status_after":"active"}`, invalidPayload: `{"countdown_id":1}`},
		{typ: daggerheartdecider.CommandTypeSceneCountdownTriggerResolve, validPayload: `{"countdown_id":"cd-1","starting_value_before":4,"starting_value_after":4,"remaining_value_before":0,"remaining_value_after":4,"status_before":"trigger_pending","status_after":"active"}`, invalidPayload: `{"countdown_id":1}`},
		{typ: daggerheartdecider.CommandTypeSceneCountdownDelete, validPayload: `{"countdown_id":"cd-1"}`, invalidPayload: `{"countdown_id":1}`},
		{typ: daggerheartdecider.CommandTypeCampaignCountdownCreate, validPayload: `{"countdown_id":"camp-cd-1","name":"Long Project","tone":"progress","advancement_policy":"long_rest","starting_value":6,"remaining_value":6,"loop_behavior":"none","status":"active"}`, invalidPayload: `{"countdown_id":1}`},
		{typ: daggerheartdecider.CommandTypeCampaignCountdownAdvance, validPayload: `{"countdown_id":"camp-cd-1","before_remaining":6,"after_remaining":5,"advanced_by":1,"status_before":"active","status_after":"active"}`, invalidPayload: `{"countdown_id":1}`},
		{typ: daggerheartdecider.CommandTypeCampaignCountdownTriggerResolve, validPayload: `{"countdown_id":"camp-cd-1","starting_value_before":6,"starting_value_after":6,"remaining_value_before":0,"remaining_value_after":6,"status_before":"trigger_pending","status_after":"active"}`, invalidPayload: `{"countdown_id":1}`},
		{typ: daggerheartdecider.CommandTypeCampaignCountdownDelete, validPayload: `{"countdown_id":"camp-cd-1"}`, invalidPayload: `{"countdown_id":1}`},
...
func eventValidationCases() []eventValidationCase {
	return []eventValidationCase{
		...
		{typ: daggerheartpayload.EventTypeSceneCountdownAdvanced, validPayload: `{"countdown_id":"cd-1","before_remaining":2,"after_remaining":1,"advanced_by":1,"status_before":"active","status_after":"active"}`, invalidPayload: `{"countdown_id":1}`},
		{typ: daggerheartpayload.EventTypeSceneCountdownTriggerResolved, validPayload: `{"countdown_id":"cd-1","starting_value_before":4,"starting_value_after":4,"remaining_value_before":0,"remaining_value_after":4,"status_before":"trigger_pending","status_after":"active"}`, invalidPayload: `{"countdown_id":1}`},
		{typ: daggerheartpayload.EventTypeSceneCountdownDeleted, validPayload: `{"countdown_id":"cd-1"}`, invalidPayload: `{"countdown_id":1}`},
		{typ: daggerheartpayload.EventTypeCampaignCountdownCreated, validPayload: `{"countdown_id":"camp-cd-1","name":"Long Project","tone":"progress","advancement_policy":"long_rest","starting_value":6,"remaining_value":6,"loop_behavior":"none","status":"active"}`, invalidPayload: `{"countdown_id":1}`},
		{typ: daggerheartpayload.EventTypeCampaignCountdownAdvanced, validPayload: `{"countdown_id":"camp-cd-1","before_remaining":6,"after_remaining":5,"advanced_by":1,"status_before":"active","status_after":"active"}`, invalidPayload: `{"countdown_id":1}`},
		{typ: daggerheartpayload.EventTypeCampaignCountdownTriggerResolved, validPayload: `{"countdown_id":"camp-cd-1","starting_value_before":6,"starting_value_after":6,"remaining_value_before":0,"remaining_value_after":6,"status_before":"trigger_pending","status_after":"active"}`, invalidPayload: `{"countdown_id":1}`},
		{typ: daggerheartpayload.EventTypeCampaignCountdownDeleted, validPayload: `{"countdown_id":"camp-cd-1"}`, invalidPayload: `{"countdown_id":1}`},
...
func TestModuleRegisterCommands_RejectsNoOpMutatingPayloads(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			typ:     daggerheartdecider.CommandTypeSceneCountdownAdvance,
			payload: `{"countdown_id":"cd-1","before_remaining":3,"after_remaining":3,"advanced_by":1,"status_before":"active","status_after":"active"}`,
		},
		{
