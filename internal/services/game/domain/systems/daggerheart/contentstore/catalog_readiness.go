...
func EvaluateDaggerheartCatalogReadiness(ctx context.Context, store DaggerheartCatalogReadinessStore) (DaggerheartCatalogReadiness, error) {
	...
	checks := []struct {
		...
		{section: DaggerheartCatalogSectionClasses, count: func(ctx context.Context) (int, error) {
			items, err := store.ListDaggerheartClasses(ctx)
			return len(items), err
		}},
		{section: DaggerheartCatalogSectionSubclasses, count: func(ctx context.Context) (int, error) {
			items, err := store.ListDaggerheartSubclasses(ctx)
			return len(items), err
		}},
		{section: DaggerheartCatalogSectionHeritages, count: func(ctx context.Context) (int, error) {
			items, err := store.ListDaggerheartHeritages(ctx)
			return len(items), err
		}},
		{section: DaggerheartCatalogSectionExperiences, count: func(ctx context.Context) (int, error) {
			items, err := store.ListDaggerheartExperiences(ctx)
			return len(items), err
		}},
		{section: DaggerheartCatalogSectionAdversaryEntries, count: func(ctx context.Context) (int, error) {
			items, err := store.ListDaggerheartAdversaryEntries(ctx)
			return len(items), err
		}},
		{section: DaggerheartCatalogSectionBeastforms, count: func(ctx context.Context) (int, error) {
			items, err := store.ListDaggerheartBeastforms(ctx)
			return len(items), err
		}},
		{section: DaggerheartCatalogSectionCompanionExperiences, count: func(ctx context.Context) (int, error) {
			items, err := store.ListDaggerheartCompanionExperiences(ctx)
			return len(items), err
		}},
		{section: DaggerheartCatalogSectionLootEntries, count: func(ctx context.Context) (int, error) {
			items, err := store.ListDaggerheartLootEntries(ctx)
			return len(items), err
		}},
		{section: DaggerheartCatalogSectionDamageTypes, count: func(ctx context.Context) (int, error) {
			items, err := store.ListDaggerheartDamageTypes(ctx)
			return len(items), err
		}},
		{section: DaggerheartCatalogSectionDomains, count: func(ctx context.Context) (int, error) {
			items, err := store.ListDaggerheartDomains(ctx)
			return len(items), err
		}},
		{section: DaggerheartCatalogSectionDomainCards, count: func(ctx context.Context) (int, error) {
			items, err := store.ListDaggerheartDomainCards(ctx)
			return len(items), err
		}},
		{section: DaggerheartCatalogSectionWeapons, count: func(ctx context.Context) (int, error) {
			items, err := store.ListDaggerheartWeapons(ctx)
			return len(items), err
		}},
		{section: DaggerheartCatalogSectionArmor, count: func(ctx context.Context) (int, error) {
			items, err := store.ListDaggerheartArmor(ctx)
			return len(items), err
		}},
		{section: DaggerheartCatalogSectionItems, count: func(ctx context.Context) (int, error) {
			items, err := store.ListDaggerheartItems(ctx)
			return len(items), err
		}},
		{section: DaggerheartCatalogSectionEnvironments, count: func(ctx context.Context) (int, error) {
