...
func MechanicsManifest() []Mechanic {
	return []Mechanic{
		...
		},
		{
			...
			Status:       MechanicImplemented,
			Requirement:  Required,
			Commands:     []command.Type{daggerheartdecider.CommandTypeCountdownCreate, daggerheartdecider.CommandTypeCountdownUpdate, daggerheartdecider.CommandTypeCountdownDelete},
			Events:       []event.Type{daggerheartpayload.EventTypeCountdownCreated, daggerheartpayload.EventTypeCountdownUpdated, daggerheartpayload.EventTypeCountdownDeleted},
		...
		},
		{
			...
			Status:       MechanicImplemented,
			Requirement:  Optional,
			Commands:     []command.Type{daggerheartdecider.CommandTypeCountdownCreate},
			Events:       []event.Type{daggerheartpayload.EventTypeCountdownCreated},
