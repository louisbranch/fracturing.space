...
func MechanicsManifest() []Mechanic {
	return []Mechanic{
		...
		},
		{
			...
			Status:       MechanicImplemented,
			Requirement:  Optional,
			Commands:     []command.Type{commandTypeClassFeatureApply},
			Events:       []event.Type{EventTypeCharacterStatePatched},
		...
		},
		{
			...
			Status:       MechanicImplemented,
			Requirement:  Optional,
			Commands:     []command.Type{commandTypeSubclassFeatureApply},
			Events:       []event.Type{EventTypeCharacterStatePatched, EventTypeConditionChanged, EventTypeAdversaryConditionChanged},
			ScenarioTags: []string{"class_feature_core"},
		...
		// ── GM Mechanics ────────────────────────────────────────────────
		{
			...
			Status:       MechanicImplemented,
			Requirement:  Required,
			Commands:     []command.Type{commandTypeGMFearSet, commandTypeGMMoveApply},
			Events:       []event.Type{EventTypeGMFearChanged, EventTypeGMMoveApplied},
		...
		},
		{
			...
			Status:       MechanicImplemented,
			Requirement:  Optional,
			Commands:     []command.Type{commandTypeAdversaryFeatureApply, commandTypeGMMoveApply},
			Events:       []event.Type{EventTypeAdversaryUpdated, EventTypeAdversaryDamageApplied, EventTypeAdversaryConditionChanged, EventTypeDamageApplied, EventTypeCharacterStatePatched, EventTypeGMMoveApplied},
		...
		},
		{
			...
			Status:       MechanicImplemented,
			Requirement:  Optional,
			Commands:     []command.Type{commandTypeEnvironmentEntityCreate, commandTypeEnvironmentEntityUpdate, commandTypeEnvironmentEntityDelete, commandTypeGMMoveApply},
			Events:       []event.Type{EventTypeEnvironmentEntityCreated, EventTypeEnvironmentEntityUpdated, EventTypeEnvironmentEntityDeleted, EventTypeGMMoveApplied},
		...
		},
		{
			...
			Status:       MechanicPending,
			Requirement:  Optional,
			Commands:     []command.Type{commandTypeCompanionExperienceBegin, commandTypeCompanionReturn},
			Events:       []event.Type{EventTypeCompanionExperienceBegun, EventTypeCompanionReturned},
			ScenarioTags: []string{"companion_experience_stress_clear"},
		...
		},
		{
			...
			Status:      MechanicImplemented,
			Requirement: Optional,
			Commands:    []command.Type{commandTypeBeastformTransform, commandTypeBeastformDrop},
			Events:      []event.Type{EventTypeBeastformTransformed, EventTypeBeastformDropped},
