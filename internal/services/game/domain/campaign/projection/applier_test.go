...
func TestApplyInviteRevoked(t *testing.T) {
	ctx := context.Background()
	inviteStore := newFakeInviteStore()
	inviteStore.invites["inv-1"] = invite.Invite{ID: "inv-1", CampaignID: "camp-1", Status: invite.StatusPending}
	campaignStore := newProjectionCampaignStore()
	campaignStore.campaigns["camp-1"] = campaign.Campaign{ID: "camp-1"}
	applier := Applier{Invite: inviteStore, Campaign: campaignStore}

	payload := event.InviteRevokedPayload{InviteID: "inv-1"}
	data, _ := json.Marshal(payload)
	stamp := time.Date(2026, 2, 11, 10, 0, 0, 0, time.UTC)
	evt := event.Event{CampaignID: "camp-1", EntityID: "inv-1", Type: event.TypeInviteRevoked, PayloadJSON: data, Timestamp: stamp}
...
func TestApplyInviteRevoked_MissingStores(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.InviteRevokedPayload{InviteID: "inv-1"})
	evt := event.Event{CampaignID: "camp-1", EntityID: "inv-1", Type: event.TypeInviteRevoked, PayloadJSON: data}

	// Missing invite store
	if err := (Applier{Campaign: newProjectionCampaignStore()}).Apply(ctx, evt); err == nil {
		t.Fatal("expected error for missing invite store")
	}
	// Missing campaign store
	if err := (Applier{Invite: newFakeInviteStore()}).Apply(ctx, evt); err == nil {
...
func TestApplyInviteRevoked_MissingEntityID(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.InviteRevokedPayload{})
	evt := event.Event{CampaignID: "camp-1", EntityID: "", Type: event.TypeInviteRevoked, PayloadJSON: data}
...
func TestApplyInviteUpdated(t *testing.T) {
	...
	payload := event.InviteUpdatedPayload{InviteID: "inv-1", Status: "REVOKED"}
	data, _ := json.Marshal(payload)
	stamp := time.Date(2026, 2, 11, 11, 0, 0, 0, time.UTC)
	evt := event.Event{CampaignID: "camp-1", EntityID: "inv-1", Type: event.TypeInviteUpdated, PayloadJSON: data, Timestamp: stamp}
...
func TestApplyInviteUpdated_EntityIDFallback(t *testing.T) {
	...
	payload := event.InviteUpdatedPayload{InviteID: "", Status: "CLAIMED"}
	data, _ := json.Marshal(payload)
	evt := event.Event{CampaignID: "camp-1", EntityID: "inv-2", Type: event.TypeInviteUpdated, PayloadJSON: data, Timestamp: time.Now()}
...
func TestApplyInviteUpdated_MissingStore(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.InviteUpdatedPayload{InviteID: "inv-1", Status: "PENDING"})
	evt := event.Event{CampaignID: "camp-1", Type: event.TypeInviteUpdated, PayloadJSON: data}
	if err := (Applier{}).Apply(ctx, evt); err == nil {
		t.Fatal("expected error for missing invite store")
	}
}
...
func TestApplyInviteUpdated_MissingInviteID(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.InviteUpdatedPayload{InviteID: "", Status: "PENDING"})
	evt := event.Event{CampaignID: "camp-1", EntityID: "", Type: event.TypeInviteUpdated, PayloadJSON: data}
...
func TestApplySessionGateAbandoned(t *testing.T) {
	...
	gateStore.gates["camp-1:sess-1:gate-1"] = storage.SessionGate{
		CampaignID: "camp-1", SessionID: "sess-1", GateID: "gate-1", Status: "OPEN",
	}
	applier := Applier{SessionGate: gateStore}

	payload := event.SessionGateAbandonedPayload{GateID: "gate-1", Reason: "timeout"}
	data, _ := json.Marshal(payload)
	stamp := time.Date(2026, 2, 11, 12, 0, 0, 0, time.UTC)
	evt := event.Event{
		CampaignID: "camp-1", SessionID: "sess-1", EntityID: "gate-1",
		Type: event.TypeSessionGateAbandoned, PayloadJSON: data, Timestamp: stamp,
	}
	...
	if gate.Status != string(session.GateStatusAbandoned) {
...
func TestApplySessionGateAbandoned_MissingStore(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.SessionGateAbandonedPayload{GateID: "gate-1"})
	evt := event.Event{CampaignID: "camp-1", SessionID: "sess-1", Type: event.TypeSessionGateAbandoned, PayloadJSON: data}
	if err := (Applier{}).Apply(ctx, evt); err == nil {
...
func TestApplySessionGateAbandoned_MissingSessionID(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.SessionGateAbandonedPayload{GateID: "gate-1"})
	evt := event.Event{CampaignID: "camp-1", SessionID: "", Type: event.TypeSessionGateAbandoned, PayloadJSON: data}
...
func TestApplySessionSpotlightSet(t *testing.T) {
	...
	payload := event.SessionSpotlightSetPayload{SpotlightType: "character", CharacterID: "char-1"}
	data, _ := json.Marshal(payload)
	stamp := time.Date(2026, 2, 11, 13, 0, 0, 0, time.UTC)
	evt := event.Event{
		CampaignID: "camp-1", SessionID: "sess-1",
		Type: event.TypeSessionSpotlightSet, PayloadJSON: data, Timestamp: stamp,
	}
...
func TestApplySessionSpotlightSet_MissingStore(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.SessionSpotlightSetPayload{SpotlightType: "character", CharacterID: "c1"})
	evt := event.Event{CampaignID: "camp-1", SessionID: "sess-1", Type: event.TypeSessionSpotlightSet, PayloadJSON: data}
	if err := (Applier{}).Apply(ctx, evt); err == nil {
...
func TestApplySessionSpotlightSet_MissingSessionID(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.SessionSpotlightSetPayload{SpotlightType: "character", CharacterID: "c1"})
	evt := event.Event{CampaignID: "camp-1", SessionID: "", Type: event.TypeSessionSpotlightSet, PayloadJSON: data}
...
func TestApplySessionSpotlightCleared(t *testing.T) {
	...
	data, _ := json.Marshal(event.SessionSpotlightClearedPayload{})
	evt := event.Event{
		CampaignID: "camp-1", SessionID: "sess-1",
		Type: event.TypeSessionSpotlightCleared, PayloadJSON: data,
	}
...
func TestApplySessionSpotlightCleared_MissingStore(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.SessionSpotlightClearedPayload{})
	evt := event.Event{CampaignID: "camp-1", SessionID: "sess-1", Type: event.TypeSessionSpotlightCleared, PayloadJSON: data}
	if err := (Applier{}).Apply(ctx, evt); err == nil {
		t.Fatal("expected error for missing spotlight store")
	}
}
...
func TestApplySessionSpotlightCleared_MissingSessionID(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.SessionSpotlightClearedPayload{})
	evt := event.Event{CampaignID: "camp-1", SessionID: "", Type: event.TypeSessionSpotlightCleared, PayloadJSON: data}
	applier := Applier{SessionSpotlight: newFakeSessionSpotlightStore()}
	if err := applier.Apply(ctx, evt); err == nil {
		t.Fatal("expected error for missing session ID")
	}
...
func TestApplySystemEvent_MissingAdapters(t *testing.T) {
	ctx := context.Background()
	evt := event.Event{Type: event.Type("system.custom"), SystemID: "GAME_SYSTEM_DAGGERHEART", PayloadJSON: []byte("{}")}
	if err := (Applier{}).Apply(ctx, evt); err == nil {
...
func TestApplySessionEnded(t *testing.T) {
	...
	payload := event.SessionEndedPayload{SessionID: "sess-1"}
	data, _ := json.Marshal(payload)
	stamp := time.Date(2026, 2, 11, 14, 0, 0, 0, time.UTC)
	evt := event.Event{CampaignID: "camp-1", EntityID: "sess-1", Type: event.TypeSessionEnded, PayloadJSON: data, Timestamp: stamp}
...
func TestApplySessionEnded_MissingStore(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.SessionEndedPayload{SessionID: "sess-1"})
	evt := event.Event{CampaignID: "camp-1", Type: event.TypeSessionEnded, PayloadJSON: data}
	if err := (Applier{}).Apply(ctx, evt); err == nil {
...
func TestApplySessionEnded_MissingCampaignID(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.SessionEndedPayload{SessionID: "sess-1"})
	evt := event.Event{CampaignID: "", Type: event.TypeSessionEnded, PayloadJSON: data}
...
func TestParseCampaignStatus(t *testing.T) {
	tests := []struct {
		input string
		want  campaign.CampaignStatus
		err   bool
	}{
		{"draft", campaign.CampaignStatusDraft, false},
		{"ACTIVE", campaign.CampaignStatusActive, false},
		{"completed", campaign.CampaignStatusCompleted, false},
		{"ARCHIVED", campaign.CampaignStatusArchived, false},
		{"CAMPAIGN_STATUS_DRAFT", campaign.CampaignStatusDraft, false},
		{"CAMPAIGN_STATUS_ACTIVE", campaign.CampaignStatusActive, false},
		{"CAMPAIGN_STATUS_COMPLETED", campaign.CampaignStatusCompleted, false},
		{"CAMPAIGN_STATUS_ARCHIVED", campaign.CampaignStatusArchived, false},
		{"", campaign.CampaignStatusUnspecified, true},
		{"   ", campaign.CampaignStatusUnspecified, true},
		{"unknown", campaign.CampaignStatusUnspecified, true},
	}
...
func TestParseParticipantRole(t *testing.T) {
	tests := []struct {
		input string
		want  participant.ParticipantRole
		err   bool
	}{
		{"gm", participant.ParticipantRoleGM, false},
		{"PLAYER", participant.ParticipantRolePlayer, false},
		{"GM", participant.ParticipantRoleGM, false},
		{"player", participant.ParticipantRolePlayer, false},
		{"", participant.ParticipantRoleUnspecified, true},
		{"observer", participant.ParticipantRoleUnspecified, true},
	}
	for _, tt := range tests {
...
func TestParseCharacterKind(t *testing.T) {
	tests := []struct {
		input string
		want  character.CharacterKind
		err   bool
	}{
		{"pc", character.CharacterKindPC, false},
		{"NPC", character.CharacterKindNPC, false},
		{"CHARACTER_KIND_PC", character.CharacterKindPC, false},
		{"CHARACTER_KIND_NPC", character.CharacterKindNPC, false},
		{"PC", character.CharacterKindPC, false},
		{"npc", character.CharacterKindNPC, false},
		{"", character.CharacterKindUnspecified, true},
		{"enemy", character.CharacterKindUnspecified, true},
	}
	for _, tt := range tests {
...
func TestApplyCampaignForked(t *testing.T) {
	...
	payload := event.CampaignForkedPayload{
		ParentCampaignID: "parent-1",
		ForkEventSeq:     42,
		OriginCampaignID: "origin-1",
	}
	data, _ := json.Marshal(payload)
	evt := event.Event{CampaignID: "camp-1", Type: event.TypeCampaignForked, PayloadJSON: data}
...
func TestApplyCampaignForked_MissingStore(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.CampaignForkedPayload{})
	evt := event.Event{CampaignID: "camp-1", Type: event.TypeCampaignForked, PayloadJSON: data}
	if err := (Applier{}).Apply(ctx, evt); err == nil {
...
func TestApplyCampaignForked_MissingCampaignID(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.CampaignForkedPayload{})
	evt := event.Event{CampaignID: "", Type: event.TypeCampaignForked, PayloadJSON: data}
...
func TestApplyParticipantUpdated(t *testing.T) {
	...
	pStore.participants["camp-1:part-1"] = participant.Participant{
		ID: "part-1", CampaignID: "camp-1", UserID: "user-1",
		DisplayName: "Old Name", Role: participant.ParticipantRolePlayer,
		Controller: participant.ControllerHuman, CampaignAccess: participant.CampaignAccessMember,
	}
	cStore := newProjectionCampaignStore()
	cStore.campaigns["camp-1"] = campaign.Campaign{ID: "camp-1"}
	applier := Applier{Participant: pStore, Campaign: cStore}

	payload := event.ParticipantUpdatedPayload{Fields: map[string]any{
	...
	evt := event.Event{CampaignID: "camp-1", EntityID: "part-1", Type: event.TypeParticipantUpdated, PayloadJSON: data, Timestamp: stamp}
	...
	if updated.Role != participant.ParticipantRoleGM {
...
func TestApplyParticipantUpdated_EmptyFields(t *testing.T) {
	...
	payload := event.ParticipantUpdatedPayload{Fields: map[string]any{}}
	data, _ := json.Marshal(payload)
	evt := event.Event{CampaignID: "camp-1", EntityID: "part-1", Type: event.TypeParticipantUpdated, PayloadJSON: data}
...
func TestApplyParticipantUpdated_MissingStore(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.ParticipantUpdatedPayload{Fields: map[string]any{"display_name": "x"}})
	evt := event.Event{CampaignID: "camp-1", EntityID: "part-1", Type: event.TypeParticipantUpdated, PayloadJSON: data}
	if err := (Applier{}).Apply(ctx, evt); err == nil {
...
func TestApplyParticipantLeft(t *testing.T) {
	ctx := context.Background()
	pStore := newProjectionParticipantStore()
	pStore.participants["camp-1:part-1"] = participant.Participant{ID: "part-1", CampaignID: "camp-1"}
	cStore := newProjectionCampaignStore()
	cStore.campaigns["camp-1"] = campaign.Campaign{ID: "camp-1", ParticipantCount: 3}
	applier := Applier{Participant: pStore, Campaign: cStore}

	data, _ := json.Marshal(event.ParticipantLeftPayload{})
	stamp := time.Date(2026, 2, 11, 15, 0, 0, 0, time.UTC)
	evt := event.Event{CampaignID: "camp-1", EntityID: "part-1", Type: event.TypeParticipantLeft, PayloadJSON: data, Timestamp: stamp}
...
func TestApplyParticipantLeft_MissingStore(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.ParticipantLeftPayload{})
	evt := event.Event{CampaignID: "camp-1", EntityID: "part-1", Type: event.TypeParticipantLeft, PayloadJSON: data}
	if err := (Applier{}).Apply(ctx, evt); err == nil {
...
func TestApplyParticipantLeft_MissingEntityID(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.ParticipantLeftPayload{})
	evt := event.Event{CampaignID: "camp-1", EntityID: "", Type: event.TypeParticipantLeft, PayloadJSON: data}
...
func TestApplyParticipantBound(t *testing.T) {
	...
	payload := event.ParticipantBoundPayload{UserID: "user-1"}
	data, _ := json.Marshal(payload)
	stamp := time.Date(2026, 2, 11, 16, 0, 0, 0, time.UTC)
	evt := event.Event{CampaignID: "camp-1", EntityID: "part-1", Type: event.TypeParticipantBound, PayloadJSON: data, Timestamp: stamp}
...
func TestApplyParticipantBound_MissingUserID(t *testing.T) {
	...
	payload := event.ParticipantBoundPayload{UserID: ""}
	data, _ := json.Marshal(payload)
	evt := event.Event{CampaignID: "camp-1", EntityID: "part-1", Type: event.TypeParticipantBound, PayloadJSON: data}
...
func TestApplyParticipantBound_MissingStore(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.ParticipantBoundPayload{UserID: "u1"})
	evt := event.Event{CampaignID: "camp-1", EntityID: "part-1", Type: event.TypeParticipantBound, PayloadJSON: data}
	if err := (Applier{}).Apply(ctx, evt); err == nil {
		t.Fatal("expected error for missing store")
	}
...
func TestApplyParticipantUnbound_Success(t *testing.T) {
	ctx := context.Background()
	pStore := newProjectionParticipantStore()
	pStore.participants["camp-1:part-1"] = participant.Participant{ID: "part-1", CampaignID: "camp-1", UserID: "user-1"}
	cStore := newProjectionCampaignStore()
	cStore.campaigns["camp-1"] = campaign.Campaign{ID: "camp-1"}
	claimStore := newFakeClaimIndexStore()
	applier := Applier{Participant: pStore, Campaign: cStore, ClaimIndex: claimStore}

	payload := event.ParticipantUnboundPayload{UserID: "user-1"}
	data, _ := json.Marshal(payload)
	stamp := time.Date(2026, 2, 11, 16, 30, 0, 0, time.UTC)
	evt := event.Event{CampaignID: "camp-1", EntityID: "part-1", Type: event.TypeParticipantUnbound, PayloadJSON: data, Timestamp: stamp}
...
func TestApplyParticipantUnbound_MissingStore(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.ParticipantUnboundPayload{})
	evt := event.Event{CampaignID: "camp-1", EntityID: "part-1", Type: event.TypeParticipantUnbound, PayloadJSON: data}
	if err := (Applier{}).Apply(ctx, evt); err == nil {
		t.Fatal("expected error for missing store")
	}
...
func TestApplyParticipantUnbound_MissingCampaignID(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.ParticipantUnboundPayload{})
	evt := event.Event{CampaignID: "", EntityID: "part-1", Type: event.TypeParticipantUnbound, PayloadJSON: data}
	applier := Applier{Participant: newProjectionParticipantStore(), Campaign: newProjectionCampaignStore()}
	if err := applier.Apply(ctx, evt); err == nil {
		t.Fatal("expected error for missing campaign ID")
	}
...
func TestApplyInviteClaimed(t *testing.T) {
	...
	payload := event.InviteClaimedPayload{InviteID: "inv-1"}
	data, _ := json.Marshal(payload)
	stamp := time.Date(2026, 2, 11, 17, 0, 0, 0, time.UTC)
	evt := event.Event{CampaignID: "camp-1", EntityID: "inv-1", Type: event.TypeInviteClaimed, PayloadJSON: data, Timestamp: stamp}
...
func TestApplyInviteClaimed_MismatchID(t *testing.T) {
	...
	payload := event.InviteClaimedPayload{InviteID: "inv-other"}
	data, _ := json.Marshal(payload)
	evt := event.Event{CampaignID: "camp-1", EntityID: "inv-1", Type: event.TypeInviteClaimed, PayloadJSON: data}
...
func TestApplyInviteClaimed_MissingStore(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.InviteClaimedPayload{})
	evt := event.Event{CampaignID: "camp-1", EntityID: "inv-1", Type: event.TypeInviteClaimed, PayloadJSON: data}
	if err := (Applier{}).Apply(ctx, evt); err == nil {
		t.Fatal("expected error for missing store")
	}
...
func TestApplyInviteClaimed_MissingEntityID(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.InviteClaimedPayload{})
	evt := event.Event{CampaignID: "camp-1", EntityID: "", Type: event.TypeInviteClaimed, PayloadJSON: data}
	applier := Applier{Invite: newFakeInviteStore(), Campaign: newProjectionCampaignStore()}
	if err := applier.Apply(ctx, evt); err == nil {
		t.Fatal("expected error for missing entity ID")
	}
...
func TestApplyCharacterCreated(t *testing.T) {
	...
	cStore := newProjectionCampaignStore()
	cStore.campaigns["camp-1"] = campaign.Campaign{ID: "camp-1", CharacterCount: 1}
	applier := Applier{Character: charStore, Campaign: cStore}

	payload := event.CharacterCreatedPayload{Name: "Aragorn", Kind: "PC", Notes: "A ranger"}
	data, _ := json.Marshal(payload)
	stamp := time.Date(2026, 2, 11, 17, 30, 0, 0, time.UTC)
	evt := event.Event{CampaignID: "camp-1", EntityID: "char-1", Type: event.TypeCharacterCreated, PayloadJSON: data, Timestamp: stamp}
	...
	if ch.Kind != character.CharacterKindPC {
...
func TestApplyCharacterCreated_MissingStore(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.CharacterCreatedPayload{Name: "A", Kind: "PC"})
	evt := event.Event{CampaignID: "camp-1", EntityID: "char-1", Type: event.TypeCharacterCreated, PayloadJSON: data}
	if err := (Applier{}).Apply(ctx, evt); err == nil {
		t.Fatal("expected error for missing store")
	}
}
...
func TestApplyCharacterCreated_MissingEntityID(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.CharacterCreatedPayload{Name: "A", Kind: "PC"})
	evt := event.Event{CampaignID: "camp-1", EntityID: "", Type: event.TypeCharacterCreated, PayloadJSON: data}
...
func TestApplyCharacterUpdated(t *testing.T) {
	...
	charStore.characters["camp-1:char-1"] = character.Character{
		ID: "char-1", CampaignID: "camp-1", Name: "Old", Kind: character.CharacterKindPC,
	}
	cStore := newProjectionCampaignStore()
	cStore.campaigns["camp-1"] = campaign.Campaign{ID: "camp-1"}
	applier := Applier{Character: charStore, Campaign: cStore}

	payload := event.CharacterUpdatedPayload{Fields: map[string]any{
		"name":           "New Name",
		"kind":           "NPC",
		"notes":          "Some notes",
	...
	evt := event.Event{CampaignID: "camp-1", EntityID: "char-1", Type: event.TypeCharacterUpdated, PayloadJSON: data, Timestamp: stamp}
	...
	if updated.Kind != character.CharacterKindNPC {
...
func TestApplyCharacterUpdated_EmptyFields(t *testing.T) {
	...
	payload := event.CharacterUpdatedPayload{Fields: map[string]any{}}
	data, _ := json.Marshal(payload)
	evt := event.Event{CampaignID: "camp-1", EntityID: "char-1", Type: event.TypeCharacterUpdated, PayloadJSON: data}
...
func TestApplyCharacterUpdated_MissingStore(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.CharacterUpdatedPayload{Fields: map[string]any{"name": "x"}})
	evt := event.Event{CampaignID: "camp-1", EntityID: "char-1", Type: event.TypeCharacterUpdated, PayloadJSON: data}
	if err := (Applier{}).Apply(ctx, evt); err == nil {
		t.Fatal("expected error for missing store")
	}
...
func TestApplyCharacterDeleted(t *testing.T) {
	ctx := context.Background()
	charStore := newFakeCharacterStore()
	charStore.characters["camp-1:char-1"] = character.Character{ID: "char-1", CampaignID: "camp-1"}
	cStore := newProjectionCampaignStore()
	cStore.campaigns["camp-1"] = campaign.Campaign{ID: "camp-1", CharacterCount: 3}
	applier := Applier{Character: charStore, Campaign: cStore}

	data, _ := json.Marshal(event.CharacterDeletedPayload{})
	stamp := time.Date(2026, 2, 11, 18, 30, 0, 0, time.UTC)
	evt := event.Event{CampaignID: "camp-1", EntityID: "char-1", Type: event.TypeCharacterDeleted, PayloadJSON: data, Timestamp: stamp}
...
func TestApplyCharacterDeleted_MissingStore(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.CharacterDeletedPayload{})
	evt := event.Event{CampaignID: "camp-1", EntityID: "char-1", Type: event.TypeCharacterDeleted, PayloadJSON: data}
	if err := (Applier{}).Apply(ctx, evt); err == nil {
		t.Fatal("expected error for missing store")
	}
}
...
func TestApplyCharacterDeleted_MissingEntityID(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.CharacterDeletedPayload{})
	evt := event.Event{CampaignID: "camp-1", EntityID: "", Type: event.TypeCharacterDeleted, PayloadJSON: data}
	applier := Applier{Character: newFakeCharacterStore(), Campaign: newProjectionCampaignStore()}
	if err := applier.Apply(ctx, evt); err == nil {
		t.Fatal("expected error for missing entity ID")
	}
...
func TestApplyProfileUpdated(t *testing.T) {
	...
	data, _ := json.Marshal(payload)
	evt := event.Event{CampaignID: "camp-1", EntityID: "char-1", Type: event.TypeProfileUpdated, PayloadJSON: data}
...
func TestApplyProfileUpdated_NilSystemProfile(t *testing.T) {
	...
	payload := event.ProfileUpdatedPayload{SystemProfile: nil}
	data, _ := json.Marshal(payload)
	evt := event.Event{CampaignID: "camp-1", EntityID: "char-1", Type: event.TypeProfileUpdated, PayloadJSON: data}
...
func TestApplyProfileUpdated_NoDaggerheart(t *testing.T) {
	...
	payload := event.ProfileUpdatedPayload{SystemProfile: map[string]any{"other": "data"}}
	data, _ := json.Marshal(payload)
	evt := event.Event{CampaignID: "camp-1", EntityID: "char-1", Type: event.TypeProfileUpdated, PayloadJSON: data}
...
func TestApplyProfileUpdated_MissingStore(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.ProfileUpdatedPayload{SystemProfile: map[string]any{"daggerheart": map[string]any{}}})
	evt := event.Event{CampaignID: "camp-1", EntityID: "char-1", Type: event.TypeProfileUpdated, PayloadJSON: data}
	if err := (Applier{}).Apply(ctx, evt); err == nil {
		t.Fatal("expected error for missing store")
	}
...
func TestApplyProfileUpdated_MissingEntityID(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.ProfileUpdatedPayload{SystemProfile: map[string]any{"daggerheart": map[string]any{}}})
	evt := event.Event{CampaignID: "camp-1", EntityID: "", Type: event.TypeProfileUpdated, PayloadJSON: data}
...
func TestApplySessionGateOpened(t *testing.T) {
	...
	evt := event.Event{
		CampaignID: "camp-1", SessionID: "sess-1",
		Type: event.TypeSessionGateOpened, PayloadJSON: data, Timestamp: stamp,
		ActorType: event.ActorTypeGM, ActorID: "gm-1",
	}
...
func TestApplySessionGateOpened_FallbackEntityID(t *testing.T) {
	...
	payload := event.SessionGateOpenedPayload{GateID: "", GateType: "choice", Reason: "test"}
	data, _ := json.Marshal(payload)
	evt := event.Event{
		CampaignID: "camp-1", SessionID: "sess-1", EntityID: "gate-fallback",
		Type: event.TypeSessionGateOpened, PayloadJSON: data,
	}
...
func TestApplySessionGateOpened_MissingStore(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.SessionGateOpenedPayload{GateID: "g", GateType: "choice"})
	evt := event.Event{CampaignID: "camp-1", SessionID: "sess-1", Type: event.TypeSessionGateOpened, PayloadJSON: data}
	if err := (Applier{}).Apply(ctx, evt); err == nil {
		t.Fatal("expected error for missing store")
	}
}
...
func TestApplySessionGateOpened_MissingSessionID(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.SessionGateOpenedPayload{GateID: "g", GateType: "choice"})
	evt := event.Event{CampaignID: "camp-1", SessionID: "", Type: event.TypeSessionGateOpened, PayloadJSON: data}
	applier := Applier{SessionGate: newFakeSessionGateStore()}
	if err := applier.Apply(ctx, evt); err == nil {
		t.Fatal("expected error for missing session ID")
	}
...
func TestApplySessionGateOpened_MissingGateID(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.SessionGateOpenedPayload{GateID: "", GateType: "choice"})
	evt := event.Event{CampaignID: "camp-1", SessionID: "sess-1", EntityID: "", Type: event.TypeSessionGateOpened, PayloadJSON: data}
	applier := Applier{SessionGate: newFakeSessionGateStore()}
	if err := applier.Apply(ctx, evt); err == nil {
...
func TestApplySessionGateResolved(t *testing.T) {
	...
	evt := event.Event{
		CampaignID: "camp-1", SessionID: "sess-1",
		Type: event.TypeSessionGateResolved, PayloadJSON: data, Timestamp: stamp,
		ActorType: event.ActorTypeGM, ActorID: "gm-1",
	}
	...
	if gate.Status != string(session.GateStatusResolved) {
...
func TestApplySessionGateResolved_MissingStore(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.SessionGateResolvedPayload{GateID: "g"})
	evt := event.Event{CampaignID: "camp-1", SessionID: "sess-1", Type: event.TypeSessionGateResolved, PayloadJSON: data}
	if err := (Applier{}).Apply(ctx, evt); err == nil {
		t.Fatal("expected error for missing store")
	}
}
...
func TestApplySessionGateResolved_MissingGateID(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.SessionGateResolvedPayload{GateID: ""})
	evt := event.Event{CampaignID: "camp-1", SessionID: "sess-1", EntityID: "", Type: event.TypeSessionGateResolved, PayloadJSON: data}
	applier := Applier{SessionGate: newFakeSessionGateStore()}
	if err := applier.Apply(ctx, evt); err == nil {
		t.Fatal("expected error for missing gate ID")
	}
...
func TestApplyCampaignCreated(t *testing.T) {
	...
	data, _ := json.Marshal(payload)
	stamp := time.Date(2026, 2, 11, 10, 0, 0, 0, time.UTC)
	evt := event.Event{EntityID: "camp-1", Type: event.TypeCampaignCreated, PayloadJSON: data, Timestamp: stamp}
...
func TestApplyCampaignCreated_MissingStore(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.CampaignCreatedPayload{Name: "X", GameSystem: "GAME_SYSTEM_DAGGERHEART", GmMode: "human"})
	evt := event.Event{EntityID: "camp-1", Type: event.TypeCampaignCreated, PayloadJSON: data}
	if err := (Applier{}).Apply(ctx, evt); err == nil {
		t.Fatal("expected error for missing campaign store")
	}
}
...
func TestApplyCampaignCreated_MissingEntityID(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.CampaignCreatedPayload{Name: "X", GameSystem: "GAME_SYSTEM_DAGGERHEART", GmMode: "human"})
	evt := event.Event{EntityID: "", Type: event.TypeCampaignCreated, PayloadJSON: data}
...
func TestApplyCampaignCreated_InvalidJSON(t *testing.T) {
	ctx := context.Background()
	evt := event.Event{EntityID: "camp-1", Type: event.TypeCampaignCreated, PayloadJSON: []byte("{")}
	applier := Applier{Campaign: newProjectionCampaignStore()}
	if err := applier.Apply(ctx, evt); err == nil {
...
func TestApplyCampaignCreated_InvalidGameSystem(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.CampaignCreatedPayload{Name: "X", GameSystem: "", GmMode: "human"})
	evt := event.Event{EntityID: "camp-1", Type: event.TypeCampaignCreated, PayloadJSON: data}
	applier := Applier{Campaign: newProjectionCampaignStore()}
	if err := applier.Apply(ctx, evt); err == nil {
...
func TestApplyCampaignCreated_InvalidGmMode(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.CampaignCreatedPayload{Name: "X", GameSystem: "DAGGERHEART", GmMode: ""})
	evt := event.Event{EntityID: "camp-1", Type: event.TypeCampaignCreated, PayloadJSON: data}
	applier := Applier{Campaign: newProjectionCampaignStore()}
	if err := applier.Apply(ctx, evt); err == nil {
...
func TestApplyCampaignUpdated_ThemePrompt(t *testing.T) {
	ctx := context.Background()
	store := newProjectionCampaignStore()
	store.campaigns["camp-1"] = campaign.Campaign{ID: "camp-1", Status: campaign.CampaignStatusDraft, ThemePrompt: "old"}
	applier := Applier{Campaign: store}

	payload := event.CampaignUpdatedPayload{Fields: map[string]any{"theme_prompt": "  new theme  "}}
	data, _ := json.Marshal(payload)
	evt := event.Event{CampaignID: "camp-1", Type: event.TypeCampaignUpdated, PayloadJSON: data, Timestamp: time.Now()}
...
func TestApplyCampaignUpdated_EmptyFields(t *testing.T) {
	ctx := context.Background()
	store := newProjectionCampaignStore()
	store.campaigns["camp-1"] = campaign.Campaign{ID: "camp-1"}
	applier := Applier{Campaign: store}

	payload := event.CampaignUpdatedPayload{Fields: map[string]any{}}
	data, _ := json.Marshal(payload)
	evt := event.Event{CampaignID: "camp-1", Type: event.TypeCampaignUpdated, PayloadJSON: data}
...
func TestApplyCampaignUpdated_MissingStore(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.CampaignUpdatedPayload{Fields: map[string]any{"name": "X"}})
	evt := event.Event{CampaignID: "camp-1", Type: event.TypeCampaignUpdated, PayloadJSON: data}
	if err := (Applier{}).Apply(ctx, evt); err == nil {
		t.Fatal("expected error for missing campaign store")
	}
...
func TestApplyCampaignUpdated_MissingCampaignID(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.CampaignUpdatedPayload{Fields: map[string]any{"name": "X"}})
	evt := event.Event{CampaignID: "", Type: event.TypeCampaignUpdated, PayloadJSON: data}
	applier := Applier{Campaign: newProjectionCampaignStore()}
	if err := applier.Apply(ctx, evt); err == nil {
		t.Fatal("expected error for missing campaign ID")
	}
...
func TestApplyCampaignUpdated_InvalidNameType(t *testing.T) {
	...
	payload := event.CampaignUpdatedPayload{Fields: map[string]any{"name": 42}}
	data, _ := json.Marshal(payload)
	evt := event.Event{CampaignID: "camp-1", Type: event.TypeCampaignUpdated, PayloadJSON: data}
...
func TestApplyCampaignUpdated_EmptyName(t *testing.T) {
	...
	payload := event.CampaignUpdatedPayload{Fields: map[string]any{"name": "  "}}
	data, _ := json.Marshal(payload)
	evt := event.Event{CampaignID: "camp-1", Type: event.TypeCampaignUpdated, PayloadJSON: data}
...
func TestApplyCampaignUpdated_InvalidStatusType(t *testing.T) {
	ctx := context.Background()
	store := newProjectionCampaignStore()
	store.campaigns["camp-1"] = campaign.Campaign{ID: "camp-1", Status: campaign.CampaignStatusDraft}
	applier := Applier{Campaign: store}

	payload := event.CampaignUpdatedPayload{Fields: map[string]any{"status": 42}}
	data, _ := json.Marshal(payload)
	evt := event.Event{CampaignID: "camp-1", Type: event.TypeCampaignUpdated, PayloadJSON: data}
...
func TestApplyCampaignUpdated_InvalidThemePromptType(t *testing.T) {
	...
	payload := event.CampaignUpdatedPayload{Fields: map[string]any{"theme_prompt": 42}}
	data, _ := json.Marshal(payload)
	evt := event.Event{CampaignID: "camp-1", Type: event.TypeCampaignUpdated, PayloadJSON: data}
...
func TestApplyParticipantJoined(t *testing.T) {
	...
	participantStore := newProjectionParticipantStore()
	campaignStore := newProjectionCampaignStore()
	campaignStore.campaigns["camp-1"] = campaign.Campaign{ID: "camp-1", ParticipantCount: 0}
	applier := Applier{Participant: participantStore, Campaign: campaignStore}
	...
	data, _ := json.Marshal(payload)
	stamp := time.Date(2026, 2, 11, 10, 0, 0, 0, time.UTC)
	evt := event.Event{CampaignID: "camp-1", EntityID: "part-1", Type: event.TypeParticipantJoined, PayloadJSON: data, Timestamp: stamp}
...
func TestApplyParticipantJoined_MissingStores(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.ParticipantJoinedPayload{UserID: "u", DisplayName: "A", Role: "player", Controller: "human", CampaignAccess: "member"})
	evt := event.Event{CampaignID: "camp-1", EntityID: "part-1", Type: event.TypeParticipantJoined, PayloadJSON: data}

	if err := (Applier{Campaign: newProjectionCampaignStore()}).Apply(ctx, evt); err == nil {
		t.Fatal("expected error for missing participant store")
	}
	if err := (Applier{Participant: newProjectionParticipantStore()}).Apply(ctx, evt); err == nil {
		t.Fatal("expected error for missing campaign store")
	}
}
...
func TestApplyParticipantJoined_MissingEntityID(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.ParticipantJoinedPayload{UserID: "u", DisplayName: "A", Role: "player", Controller: "human", CampaignAccess: "member"})
	evt := event.Event{CampaignID: "camp-1", EntityID: "", Type: event.TypeParticipantJoined, PayloadJSON: data}
	applier := Applier{Participant: newProjectionParticipantStore(), Campaign: newProjectionCampaignStore()}
	if err := applier.Apply(ctx, evt); err == nil {
		t.Fatal("expected error for missing entity ID")
	}
...
func TestApplyParticipantJoined_MissingCampaignID(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.ParticipantJoinedPayload{UserID: "u", DisplayName: "A", Role: "player", Controller: "human", CampaignAccess: "member"})
	evt := event.Event{CampaignID: "", EntityID: "part-1", Type: event.TypeParticipantJoined, PayloadJSON: data}
	applier := Applier{Participant: newProjectionParticipantStore(), Campaign: newProjectionCampaignStore()}
	if err := applier.Apply(ctx, evt); err == nil {
		t.Fatal("expected error for missing campaign ID")
	}
...
func TestApplySeatReassigned_MissingStores(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.SeatReassignedPayload{UserID: "user-new"})
	evt := event.Event{CampaignID: "camp-1", EntityID: "part-1", Type: event.TypeSeatReassigned, PayloadJSON: data}
...
func TestApplySeatReassigned_MissingCampaignID(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.SeatReassignedPayload{UserID: "user-new"})
	evt := event.Event{CampaignID: "", EntityID: "part-1", Type: event.TypeSeatReassigned, PayloadJSON: data}
	applier := Applier{Participant: newProjectionParticipantStore(), Campaign: newProjectionCampaignStore()}
	if err := applier.Apply(ctx, evt); err == nil {
		t.Fatal("expected error for missing campaign ID")
	}
...
func TestApplySeatReassigned_MissingEntityID(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.SeatReassignedPayload{UserID: "user-new"})
	evt := event.Event{CampaignID: "camp-1", EntityID: "", Type: event.TypeSeatReassigned, PayloadJSON: data}
	applier := Applier{Participant: newProjectionParticipantStore(), Campaign: newProjectionCampaignStore()}
	if err := applier.Apply(ctx, evt); err == nil {
		t.Fatal("expected error for missing entity ID")
	}
...
func TestApplySeatReassigned_MissingUserID(t *testing.T) {
	...
	data, _ := json.Marshal(event.SeatReassignedPayload{UserID: "", PriorUserID: "user-old"})
	evt := event.Event{CampaignID: "camp-1", EntityID: "part-1", Type: event.TypeSeatReassigned, PayloadJSON: data}
	if err := applier.Apply(ctx, evt); err == nil {
		t.Fatal("expected error for missing user ID")
	}
...
func TestApplySeatReassigned_PriorUserMismatch(t *testing.T) {
	...
	data, _ := json.Marshal(event.SeatReassignedPayload{UserID: "user-new", PriorUserID: "user-wrong"})
	evt := event.Event{CampaignID: "camp-1", EntityID: "part-1", Type: event.TypeSeatReassigned, PayloadJSON: data}
	if err := applier.Apply(ctx, evt); err == nil {
...
func TestApplySeatReassigned_NoClaims(t *testing.T) {
	...
	data, _ := json.Marshal(event.SeatReassignedPayload{UserID: "user-new"})
	evt := event.Event{CampaignID: "camp-1", EntityID: "part-1", Type: event.TypeSeatReassigned, PayloadJSON: data, Timestamp: time.Now()}
	if err := applier.Apply(ctx, evt); err != nil {
		t.Fatalf("apply: %v", err)
	}
...
func TestApplyInviteCreated_MissingStores(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.InviteCreatedPayload{InviteID: "inv-1", ParticipantID: "p1", Status: "pending"})
	evt := event.Event{CampaignID: "camp-1", Type: event.TypeInviteCreated, PayloadJSON: data}
...
func TestApplyInviteCreated_MissingCampaignID(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.InviteCreatedPayload{InviteID: "inv-1", ParticipantID: "p1", Status: "pending"})
	evt := event.Event{CampaignID: "", Type: event.TypeInviteCreated, PayloadJSON: data}
	applier := Applier{Invite: newFakeInviteStore(), Campaign: newProjectionCampaignStore()}
	if err := applier.Apply(ctx, evt); err == nil {
		t.Fatal("expected error for missing campaign ID")
	}
...
func TestApplyInviteCreated_MissingInviteID(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.InviteCreatedPayload{InviteID: "", ParticipantID: "p1", Status: "pending"})
	evt := event.Event{CampaignID: "camp-1", EntityID: "", Type: event.TypeInviteCreated, PayloadJSON: data}
	campaignStore := newProjectionCampaignStore()
	campaignStore.campaigns["camp-1"] = campaign.Campaign{ID: "camp-1"}
...
func TestApplyInviteCreated_MissingParticipantID(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.InviteCreatedPayload{InviteID: "inv-1", ParticipantID: "", Status: "pending"})
	evt := event.Event{CampaignID: "camp-1", Type: event.TypeInviteCreated, PayloadJSON: data}
	campaignStore := newProjectionCampaignStore()
	campaignStore.campaigns["camp-1"] = campaign.Campaign{ID: "camp-1"}
	applier := Applier{Invite: newFakeInviteStore(), Campaign: campaignStore}
...
func TestApplySessionStarted_MissingCampaignID(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.SessionStartedPayload{SessionID: "sess-1"})
	evt := event.Event{CampaignID: "", Type: event.TypeSessionStarted, PayloadJSON: data}
	applier := Applier{Session: &fakeSessionStore{}}
	if err := applier.Apply(ctx, evt); err == nil {
		t.Fatal("expected error for missing campaign ID")
	}
...
func TestApplySessionStarted_MissingStore(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.SessionStartedPayload{SessionID: "sess-1"})
	evt := event.Event{CampaignID: "camp-1", Type: event.TypeSessionStarted, PayloadJSON: data}
	if err := (Applier{}).Apply(ctx, evt); err == nil {
		t.Fatal("expected error for missing session store")
	}
}
...
func TestApplySessionStarted_MissingSessionID(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.SessionStartedPayload{SessionID: ""})
	evt := event.Event{CampaignID: "camp-1", EntityID: "", Type: event.TypeSessionStarted, PayloadJSON: data}
	applier := Applier{Session: &fakeSessionStore{}}
	if err := applier.Apply(ctx, evt); err == nil {
		t.Fatal("expected error for missing session ID")
	}
...
func TestApplySessionEnded_EntityIDFallback(t *testing.T) {
	...
	payload := event.SessionEndedPayload{SessionID: ""}
	data, _ := json.Marshal(payload)
	evt := event.Event{CampaignID: "camp-1", EntityID: "sess-fallback", Type: event.TypeSessionEnded, PayloadJSON: data, Timestamp: time.Now()}
...
func TestApplySessionEnded_MissingSessionID(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.SessionEndedPayload{SessionID: ""})
	evt := event.Event{CampaignID: "camp-1", EntityID: "", Type: event.TypeSessionEnded, PayloadJSON: data}
	applier := Applier{Session: &fakeSessionStore{}}
	if err := applier.Apply(ctx, evt); err == nil {
		t.Fatal("expected error for missing session ID")
	}
...
func TestApplySessionGateAbandoned_MissingCampaignID(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.SessionGateAbandonedPayload{GateID: "gate-1"})
	evt := event.Event{CampaignID: "", SessionID: "sess-1", Type: event.TypeSessionGateAbandoned, PayloadJSON: data}
	applier := Applier{SessionGate: newFakeSessionGateStore()}
	if err := applier.Apply(ctx, evt); err == nil {
		t.Fatal("expected error for missing campaign ID")
	}
...
func TestApplySessionGateAbandoned_MissingGateID(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.SessionGateAbandonedPayload{GateID: ""})
	evt := event.Event{CampaignID: "camp-1", SessionID: "sess-1", EntityID: "", Type: event.TypeSessionGateAbandoned, PayloadJSON: data}
	applier := Applier{SessionGate: newFakeSessionGateStore()}
	if err := applier.Apply(ctx, evt); err == nil {
		t.Fatal("expected error for missing gate ID")
	}
...
func TestApplySessionGateResolved_MissingCampaignID(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.SessionGateResolvedPayload{GateID: "g"})
	evt := event.Event{CampaignID: "", SessionID: "sess-1", Type: event.TypeSessionGateResolved, PayloadJSON: data}
	applier := Applier{SessionGate: newFakeSessionGateStore()}
	if err := applier.Apply(ctx, evt); err == nil {
		t.Fatal("expected error for missing campaign ID")
	}
...
func TestApplySessionGateResolved_MissingSessionID(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.SessionGateResolvedPayload{GateID: "g"})
	evt := event.Event{CampaignID: "camp-1", SessionID: "", Type: event.TypeSessionGateResolved, PayloadJSON: data}
	applier := Applier{SessionGate: newFakeSessionGateStore()}
	if err := applier.Apply(ctx, evt); err == nil {
		t.Fatal("expected error for missing session ID")
	}
...
func TestApplySessionGateOpened_MissingCampaignID(t *testing.T) {
	ctx := context.Background()
	data, _ := json.Marshal(event.SessionGateOpenedPayload{GateID: "g", GateType: "choice"})
	evt := event.Event{CampaignID: "", SessionID: "sess-1", Type: event.TypeSessionGateOpened, PayloadJSON: data}
	applier := Applier{SessionGate: newFakeSessionGateStore()}
	if err := applier.Apply(ctx, evt); err == nil {
		t.Fatal("expected error for missing campaign ID")
	}
...
func TestApplyParticipantUpdated_InvalidUserIDType(t *testing.T) {
	ctx := context.Background()
	participantStore := newProjectionParticipantStore()
	participantStore.participants["camp-1:part-1"] = participant.Participant{ID: "part-1", CampaignID: "camp-1"}
	campaignStore := newProjectionCampaignStore()
	campaignStore.campaigns["camp-1"] = campaign.Campaign{ID: "camp-1"}
	applier := Applier{Participant: participantStore, Campaign: campaignStore}

	data, _ := json.Marshal(event.ParticipantUpdatedPayload{Fields: map[string]any{"user_id": 42}})
	evt := event.Event{CampaignID: "camp-1", EntityID: "part-1", Type: event.TypeParticipantUpdated, PayloadJSON: data}
	if err := applier.Apply(ctx, evt); err == nil {
...
func TestApplyParticipantUpdated_InvalidDisplayNameType(t *testing.T) {
	ctx := context.Background()
	participantStore := newProjectionParticipantStore()
	participantStore.participants["camp-1:part-1"] = participant.Participant{ID: "part-1", CampaignID: "camp-1"}
	campaignStore := newProjectionCampaignStore()
	...
	data, _ := json.Marshal(event.ParticipantUpdatedPayload{Fields: map[string]any{"display_name": 42}})
	evt := event.Event{CampaignID: "camp-1", EntityID: "part-1", Type: event.TypeParticipantUpdated, PayloadJSON: data}
	if err := applier.Apply(ctx, evt); err == nil {
...
func TestApplyParticipantUpdated_EmptyDisplayName(t *testing.T) {
	ctx := context.Background()
	participantStore := newProjectionParticipantStore()
	participantStore.participants["camp-1:part-1"] = participant.Participant{ID: "part-1", CampaignID: "camp-1"}
	campaignStore := newProjectionCampaignStore()
	...
	data, _ := json.Marshal(event.ParticipantUpdatedPayload{Fields: map[string]any{"display_name": "  "}})
	evt := event.Event{CampaignID: "camp-1", EntityID: "part-1", Type: event.TypeParticipantUpdated, PayloadJSON: data}
	if err := applier.Apply(ctx, evt); err == nil {
...
func TestApplyParticipantUpdated_InvalidRoleType(t *testing.T) {
	...
	data, _ := json.Marshal(event.ParticipantUpdatedPayload{Fields: map[string]any{"role": 42}})
	evt := event.Event{CampaignID: "camp-1", EntityID: "part-1", Type: event.TypeParticipantUpdated, PayloadJSON: data}
	if err := applier.Apply(ctx, evt); err == nil {
...
func TestApplyParticipantUpdated_InvalidControllerType(t *testing.T) {
	...
	data, _ := json.Marshal(event.ParticipantUpdatedPayload{Fields: map[string]any{"controller": 42}})
	evt := event.Event{CampaignID: "camp-1", EntityID: "part-1", Type: event.TypeParticipantUpdated, PayloadJSON: data}
	if err := applier.Apply(ctx, evt); err == nil {
...
func TestApplyParticipantUpdated_InvalidAccessType(t *testing.T) {
	...
	data, _ := json.Marshal(event.ParticipantUpdatedPayload{Fields: map[string]any{"campaign_access": 42}})
	evt := event.Event{CampaignID: "camp-1", EntityID: "part-1", Type: event.TypeParticipantUpdated, PayloadJSON: data}
	if err := applier.Apply(ctx, evt); err == nil {
...
func TestApplyCharacterUpdated_InvalidNameType(t *testing.T) {
	...
	data, _ := json.Marshal(event.CharacterUpdatedPayload{Fields: map[string]any{"name": 42}})
	evt := event.Event{CampaignID: "camp-1", EntityID: "char-1", Type: event.TypeCharacterUpdated, PayloadJSON: data}
	if err := applier.Apply(ctx, evt); err == nil {
		t.Fatal("expected error for invalid name type")
	}
...
func TestApplyCharacterUpdated_EmptyName(t *testing.T) {
	...
	data, _ := json.Marshal(event.CharacterUpdatedPayload{Fields: map[string]any{"name": "  "}})
	evt := event.Event{CampaignID: "camp-1", EntityID: "char-1", Type: event.TypeCharacterUpdated, PayloadJSON: data}
	if err := applier.Apply(ctx, evt); err == nil {
...
func TestApplyCharacterUpdated_InvalidKindType(t *testing.T) {
	...
	data, _ := json.Marshal(event.CharacterUpdatedPayload{Fields: map[string]any{"kind": 42}})
	evt := event.Event{CampaignID: "camp-1", EntityID: "char-1", Type: event.TypeCharacterUpdated, PayloadJSON: data}
	if err := applier.Apply(ctx, evt); err == nil {
...
func TestApplyCharacterUpdated_InvalidNotesType(t *testing.T) {
	...
	data, _ := json.Marshal(event.CharacterUpdatedPayload{Fields: map[string]any{"notes": 42}})
	evt := event.Event{CampaignID: "camp-1", EntityID: "char-1", Type: event.TypeCharacterUpdated, PayloadJSON: data}
	if err := applier.Apply(ctx, evt); err == nil {
...
func TestApplyCharacterUpdated_InvalidParticipantIDType(t *testing.T) {
	...
	data, _ := json.Marshal(event.CharacterUpdatedPayload{Fields: map[string]any{"participant_id": 42}})
	evt := event.Event{CampaignID: "camp-1", EntityID: "char-1", Type: event.TypeCharacterUpdated, PayloadJSON: data}
	if err := applier.Apply(ctx, evt); err == nil {
...
func TestApplyParticipantLeft_MissingCampaignStore(t *testing.T) {
	...
	evt := event.Event{CampaignID: "camp-1", EntityID: "part-1", Type: event.TypeParticipantLeft, PayloadJSON: []byte("{}")}
...
func TestApplyParticipantLeft_MissingCampaignID(t *testing.T) {
	applier := Applier{Participant: newProjectionParticipantStore(), Campaign: newProjectionCampaignStore()}
	evt := event.Event{CampaignID: "  ", EntityID: "part-1", Type: event.TypeParticipantLeft, PayloadJSON: []byte("{}")}
	if err := applier.Apply(context.Background(), evt); err == nil {
		t.Fatal("expected error for missing campaign id")
	}
}
...
func TestApplyParticipantBound_MissingCampaignStore(t *testing.T) {
	applier := Applier{Participant: newProjectionParticipantStore()}
	evt := event.Event{CampaignID: "camp-1", EntityID: "part-1", Type: event.TypeParticipantBound, PayloadJSON: []byte(`{"user_id":"u1"}`)}
	if err := applier.Apply(context.Background(), evt); err == nil {
		t.Fatal("expected error for missing campaign store")
	}
}
...
func TestApplyParticipantBound_MissingCampaignID(t *testing.T) {
	applier := Applier{Participant: newProjectionParticipantStore(), Campaign: newProjectionCampaignStore()}
	evt := event.Event{CampaignID: "  ", EntityID: "part-1", Type: event.TypeParticipantBound, PayloadJSON: []byte(`{"user_id":"u1"}`)}
	if err := applier.Apply(context.Background(), evt); err == nil {
		t.Fatal("expected error for missing campaign id")
	}
}
...
func TestApplyParticipantBound_MissingEntityID(t *testing.T) {
	applier := Applier{Participant: newProjectionParticipantStore(), Campaign: newProjectionCampaignStore()}
	evt := event.Event{CampaignID: "camp-1", EntityID: "  ", Type: event.TypeParticipantBound, PayloadJSON: []byte(`{"user_id":"u1"}`)}
	if err := applier.Apply(context.Background(), evt); err == nil {
		t.Fatal("expected error for missing entity id")
	}
}
...
func TestApplyParticipantBound_InvalidJSON(t *testing.T) {
	applier := Applier{Participant: newProjectionParticipantStore(), Campaign: newProjectionCampaignStore()}
	evt := event.Event{CampaignID: "camp-1", EntityID: "part-1", Type: event.TypeParticipantBound, PayloadJSON: []byte("{")}
	if err := applier.Apply(context.Background(), evt); err == nil {
		t.Fatal("expected error for invalid JSON")
	}
}
...
func TestApplyParticipantUnbound_MissingEntityID(t *testing.T) {
	applier := Applier{Participant: newProjectionParticipantStore(), Campaign: newProjectionCampaignStore()}
	evt := event.Event{CampaignID: "camp-1", EntityID: "  ", Type: event.TypeParticipantUnbound, PayloadJSON: []byte(`{"user_id":"u1"}`)}
	if err := applier.Apply(context.Background(), evt); err == nil {
		t.Fatal("expected error for missing entity id")
	}
}
...
func TestApplyParticipantUnbound_InvalidJSON(t *testing.T) {
	applier := Applier{Participant: newProjectionParticipantStore(), Campaign: newProjectionCampaignStore()}
	evt := event.Event{CampaignID: "camp-1", EntityID: "part-1", Type: event.TypeParticipantUnbound, PayloadJSON: []byte("{")}
	if err := applier.Apply(context.Background(), evt); err == nil {
		t.Fatal("expected error for invalid JSON")
	}
}
...
func TestApplyParticipantUnbound_NilClaimIndex(t *testing.T) {
	ctx := context.Background()
	participantStore := newProjectionParticipantStore()
	participantStore.participants["camp-1:part-1"] = participant.Participant{ID: "part-1", CampaignID: "camp-1", UserID: "u1"}
	campaignStore := newProjectionCampaignStore()
	campaignStore.campaigns["camp-1"] = campaign.Campaign{ID: "camp-1"}
	applier := Applier{Participant: participantStore, Campaign: campaignStore}
	payload := event.ParticipantUnboundPayload{}
	data, _ := json.Marshal(payload)
	evt := event.Event{CampaignID: "camp-1", EntityID: "part-1", Type: event.TypeParticipantUnbound, PayloadJSON: data}
	if err := applier.Apply(ctx, evt); err != nil {
		t.Fatalf("apply: %v", err)
...
func TestApplyInviteClaimed_MissingCampaignStore(t *testing.T) {
	applier := Applier{Invite: newFakeInviteStore()}
	evt := event.Event{CampaignID: "camp-1", EntityID: "inv-1", Type: event.TypeInviteClaimed, PayloadJSON: []byte("{}")}
	if err := applier.Apply(context.Background(), evt); err == nil {
		t.Fatal("expected error for missing campaign store")
	}
}
...
func TestApplyInviteRevoked_MismatchID(t *testing.T) {
	applier := Applier{Invite: newFakeInviteStore(), Campaign: newProjectionCampaignStore()}
	payload := event.InviteRevokedPayload{InviteID: "inv-2"}
	data, _ := json.Marshal(payload)
	evt := event.Event{CampaignID: "camp-1", EntityID: "inv-1", Type: event.TypeInviteRevoked, PayloadJSON: data}
	if err := applier.Apply(context.Background(), evt); err == nil {
		t.Fatal("expected error for invite id mismatch")
...
func TestApplyInviteRevoked_InvalidJSON(t *testing.T) {
	applier := Applier{Invite: newFakeInviteStore(), Campaign: newProjectionCampaignStore()}
	evt := event.Event{CampaignID: "camp-1", EntityID: "inv-1", Type: event.TypeInviteRevoked, PayloadJSON: []byte("{")}
	if err := applier.Apply(context.Background(), evt); err == nil {
		t.Fatal("expected error for invalid JSON")
	}
}
...
func TestApplyCharacterCreated_MissingCampaignStore(t *testing.T) {
	...
	payload := event.CharacterCreatedPayload{Name: "Hero", Kind: "PC"}
	data, _ := json.Marshal(payload)
	evt := event.Event{CampaignID: "camp-1", EntityID: "char-1", Type: event.TypeCharacterCreated, PayloadJSON: data}
	if err := applier.Apply(context.Background(), evt); err == nil {
		t.Fatal("expected error for missing campaign store")
...
func TestApplyCharacterCreated_MissingCampaignID(t *testing.T) {
	...
	payload := event.CharacterCreatedPayload{Name: "Hero", Kind: "PC"}
	data, _ := json.Marshal(payload)
	evt := event.Event{CampaignID: "  ", EntityID: "char-1", Type: event.TypeCharacterCreated, PayloadJSON: data}
	if err := applier.Apply(context.Background(), evt); err == nil {
		t.Fatal("expected error for missing campaign id")
	}
}
...
func TestApplyCharacterCreated_InvalidJSON(t *testing.T) {
	applier := Applier{Character: newFakeCharacterStore(), Campaign: newProjectionCampaignStore()}
	evt := event.Event{CampaignID: "camp-1", EntityID: "char-1", Type: event.TypeCharacterCreated, PayloadJSON: []byte("{")}
	if err := applier.Apply(context.Background(), evt); err == nil {
		t.Fatal("expected error for invalid JSON")
	}
}
...
func TestApplyCharacterCreated_InvalidKind(t *testing.T) {
	applier := Applier{Character: newFakeCharacterStore(), Campaign: newProjectionCampaignStore()}
	payload := event.CharacterCreatedPayload{Name: "Hero", Kind: "ALIEN"}
	data, _ := json.Marshal(payload)
	evt := event.Event{CampaignID: "camp-1", EntityID: "char-1", Type: event.TypeCharacterCreated, PayloadJSON: data}
	if err := applier.Apply(context.Background(), evt); err == nil {
...
func TestApplyCharacterDeleted_MissingCampaignStore(t *testing.T) {
	applier := Applier{Character: newFakeCharacterStore()}
	evt := event.Event{CampaignID: "camp-1", EntityID: "char-1", Type: event.TypeCharacterDeleted, PayloadJSON: []byte("{}")}
	if err := applier.Apply(context.Background(), evt); err == nil {
		t.Fatal("expected error for missing campaign store")
	}
}
...
func TestApplyCharacterDeleted_MissingCampaignID(t *testing.T) {
	applier := Applier{Character: newFakeCharacterStore(), Campaign: newProjectionCampaignStore()}
	evt := event.Event{CampaignID: "  ", EntityID: "char-1", Type: event.TypeCharacterDeleted, PayloadJSON: []byte("{}")}
	if err := applier.Apply(context.Background(), evt); err == nil {
		t.Fatal("expected error for missing campaign id")
	}
}
...
func TestApplyCharacterDeleted_ZeroCount(t *testing.T) {
	...
	charStore.characters["camp-1:char-1"] = character.Character{ID: "char-1", CampaignID: "camp-1"}
	campaignStore := newProjectionCampaignStore()
	campaignStore.campaigns["camp-1"] = campaign.Campaign{ID: "camp-1", CharacterCount: 0}
	applier := Applier{Character: charStore, Campaign: campaignStore}
	evt := event.Event{CampaignID: "camp-1", EntityID: "char-1", Type: event.TypeCharacterDeleted, PayloadJSON: []byte("{}")}
	if err := applier.Apply(ctx, evt); err != nil {
		t.Fatalf("apply: %v", err)
...
func TestApplyProfileUpdated_MissingCampaignID(t *testing.T) {
	applier := Applier{Daggerheart: newProjectionDaggerheartStore()}
	evt := event.Event{CampaignID: "  ", EntityID: "char-1", Type: event.TypeProfileUpdated, PayloadJSON: []byte("{}")}
	if err := applier.Apply(context.Background(), evt); err == nil {
		t.Fatal("expected error for missing campaign id")
	}
}
...
func TestApplyProfileUpdated_InvalidJSON(t *testing.T) {
	applier := Applier{Daggerheart: newProjectionDaggerheartStore()}
	evt := event.Event{CampaignID: "camp-1", EntityID: "char-1", Type: event.TypeProfileUpdated, PayloadJSON: []byte("{")}
	if err := applier.Apply(context.Background(), evt); err == nil {
		t.Fatal("expected error for invalid JSON")
	}
}
...
func TestApplySessionSpotlightSet_InvalidJSON(t *testing.T) {
	applier := Applier{SessionSpotlight: newFakeSessionSpotlightStore()}
	evt := event.Event{CampaignID: "camp-1", SessionID: "sess-1", Type: event.TypeSessionSpotlightSet, PayloadJSON: []byte("{")}
	if err := applier.Apply(context.Background(), evt); err == nil {
		t.Fatal("expected error for invalid JSON")
	}
}
...
func TestApplySystemEvent_MissingSystemID(t *testing.T) {
	...
	evt := event.Event{CampaignID: "camp-1", Type: event.Type("system.custom"), SystemID: "  ", PayloadJSON: []byte("{}")}
...
func TestApplySystemEvent_InvalidGameSystem(t *testing.T) {
	...
	registry.Register(&fakeAdapter{})
	applier := Applier{Adapters: registry}
	evt := event.Event{CampaignID: "camp-1", Type: event.Type("system.custom"), SystemID: "INVALID_SYSTEM", PayloadJSON: []byte("{}")}
	if err := applier.Apply(context.Background(), evt); err == nil {
		t.Fatal("expected error for invalid game system")
	}
}
...
func TestApplyCampaignForked_InvalidJSON(t *testing.T) {
	applier := Applier{CampaignFork: newFakeCampaignForkStore()}
	evt := event.Event{CampaignID: "camp-1", Type: event.TypeCampaignForked, PayloadJSON: []byte("{")}
	if err := applier.Apply(context.Background(), evt); err == nil {
		t.Fatal("expected error for invalid JSON")
	}
}
...
func TestApplySessionGateOpened_InvalidJSON(t *testing.T) {
	applier := Applier{SessionGate: newFakeSessionGateStore()}
	evt := event.Event{CampaignID: "camp-1", SessionID: "sess-1", Type: event.TypeSessionGateOpened, PayloadJSON: []byte("{")}
	if err := applier.Apply(context.Background(), evt); err == nil {
		t.Fatal("expected error for invalid JSON")
	}
}
...
func TestApplySessionGateResolved_EntityIDFallback(t *testing.T) {
	...
	applier := Applier{SessionGate: gateStore}
	payload := event.SessionGateResolvedPayload{Decision: "approve"}
	data, _ := json.Marshal(payload)
	evt := event.Event{CampaignID: "camp-1", SessionID: "sess-1", EntityID: "gate-1", Type: event.TypeSessionGateResolved, PayloadJSON: data}
	if err := applier.Apply(ctx, evt); err != nil {
		t.Fatalf("apply: %v", err)
	}
...
func TestApplySessionGateResolved_InvalidJSON(t *testing.T) {
	applier := Applier{SessionGate: newFakeSessionGateStore()}
	evt := event.Event{CampaignID: "camp-1", SessionID: "sess-1", EntityID: "gate-1", Type: event.TypeSessionGateResolved, PayloadJSON: []byte("{")}
	if err := applier.Apply(context.Background(), evt); err == nil {
		t.Fatal("expected error for invalid JSON")
	}
}
...
func TestApplySessionGateAbandoned_EntityIDFallback(t *testing.T) {
	...
	applier := Applier{SessionGate: gateStore}
	payload := event.SessionGateAbandonedPayload{Reason: "timeout"}
	data, _ := json.Marshal(payload)
	evt := event.Event{CampaignID: "camp-1", SessionID: "sess-1", EntityID: "gate-1", Type: event.TypeSessionGateAbandoned, PayloadJSON: data}
	if err := applier.Apply(ctx, evt); err != nil {
		t.Fatalf("apply: %v", err)
	}
	gate := gateStore.gates["camp-1:sess-1:gate-1"]
...
func TestApplySessionGateAbandoned_InvalidJSON(t *testing.T) {
	applier := Applier{SessionGate: newFakeSessionGateStore()}
	evt := event.Event{CampaignID: "camp-1", SessionID: "sess-1", EntityID: "gate-1", Type: event.TypeSessionGateAbandoned, PayloadJSON: []byte("{")}
	if err := applier.Apply(context.Background(), evt); err == nil {
		t.Fatal("expected error for invalid JSON")
	}
}
...
func TestApplyInviteCreated_InvalidJSON(t *testing.T) {
	applier := Applier{Invite: newFakeInviteStore(), Campaign: newProjectionCampaignStore()}
	evt := event.Event{CampaignID: "camp-1", Type: event.TypeInviteCreated, PayloadJSON: []byte("{")}
	if err := applier.Apply(context.Background(), evt); err == nil {
		t.Fatal("expected error for invalid JSON")
	}
}
...
func TestApplyInviteUpdated_InvalidJSON(t *testing.T) {
	applier := Applier{Invite: newFakeInviteStore()}
	evt := event.Event{CampaignID: "camp-1", EntityID: "inv-1", Type: event.TypeInviteUpdated, PayloadJSON: []byte("{")}
	if err := applier.Apply(context.Background(), evt); err == nil {
		t.Fatal("expected error for invalid JSON")
	}
}
...
func TestApplySessionStarted_InvalidJSON(t *testing.T) {
	applier := Applier{Session: &fakeSessionStore{}}
	evt := event.Event{CampaignID: "camp-1", Type: event.TypeSessionStarted, PayloadJSON: []byte("{")}
	if err := applier.Apply(context.Background(), evt); err == nil {
		t.Fatal("expected error for invalid JSON")
	}
}
...
func TestApplySessionEnded_InvalidJSON(t *testing.T) {
	applier := Applier{Session: &fakeSessionStore{}}
	evt := event.Event{CampaignID: "camp-1", Type: event.TypeSessionEnded, PayloadJSON: []byte("{")}
	if err := applier.Apply(context.Background(), evt); err == nil {
		t.Fatal("expected error for invalid JSON")
	}
}
...
func TestApplyCampaignUpdated_InvalidJSON(t *testing.T) {
	applier := Applier{Campaign: newProjectionCampaignStore()}
	evt := event.Event{CampaignID: "camp-1", Type: event.TypeCampaignUpdated, PayloadJSON: []byte("{")}
	if err := applier.Apply(context.Background(), evt); err == nil {
		t.Fatal("expected error for invalid JSON")
	}
}
...
func TestApplyCampaignUpdated_InvalidStatus(t *testing.T) {
	...
	payload := event.CampaignUpdatedPayload{Fields: map[string]any{"status": "INVALID"}}
	data, _ := json.Marshal(payload)
	evt := event.Event{CampaignID: "camp-1", Type: event.TypeCampaignUpdated, PayloadJSON: data}
	if err := applier.Apply(context.Background(), evt); err == nil {
...
func TestApplyParticipantJoined_InvalidJSON(t *testing.T) {
	applier := Applier{Participant: newProjectionParticipantStore(), Campaign: newProjectionCampaignStore()}
	evt := event.Event{CampaignID: "camp-1", EntityID: "part-1", Type: event.TypeParticipantJoined, PayloadJSON: []byte("{")}
	if err := applier.Apply(context.Background(), evt); err == nil {
		t.Fatal("expected error for invalid JSON")
	}
}
...
func TestApplyCharacterUpdated_InvalidJSON(t *testing.T) {
	applier := Applier{Character: newFakeCharacterStore(), Campaign: newProjectionCampaignStore()}
	evt := event.Event{CampaignID: "camp-1", EntityID: "char-1", Type: event.TypeCharacterUpdated, PayloadJSON: []byte("{")}
	if err := applier.Apply(context.Background(), evt); err == nil {
		t.Fatal("expected error for invalid JSON")
	}
}
...
func TestApplyCharacterUpdated_InvalidKind(t *testing.T) {
	ctx := context.Background()
	charStore := newFakeCharacterStore()
	charStore.characters["camp-1:char-1"] = character.Character{ID: "char-1", CampaignID: "camp-1", Name: "Hero"}
	campaignStore := newProjectionCampaignStore()
	campaignStore.campaigns["camp-1"] = campaign.Campaign{ID: "camp-1"}
	applier := Applier{Character: charStore, Campaign: campaignStore}
	payload := event.CharacterUpdatedPayload{Fields: map[string]any{"kind": "ALIEN"}}
	data, _ := json.Marshal(payload)
	evt := event.Event{CampaignID: "camp-1", EntityID: "char-1", Type: event.TypeCharacterUpdated, PayloadJSON: data}
	if err := applier.Apply(ctx, evt); err == nil {
		t.Fatal("expected error for invalid kind")
...
func TestApplyParticipantUpdated_MissingCampaignID(t *testing.T) {
	applier := Applier{Participant: newProjectionParticipantStore(), Campaign: newProjectionCampaignStore()}
	evt := event.Event{CampaignID: "  ", EntityID: "part-1", Type: event.TypeParticipantUpdated, PayloadJSON: []byte(`{"fields":{"display_name":"X"}}`)}
	if err := applier.Apply(context.Background(), evt); err == nil {
		t.Fatal("expected error for missing campaign id")
	}
}
...
func TestApplyParticipantUpdated_MissingEntityID(t *testing.T) {
	applier := Applier{Participant: newProjectionParticipantStore(), Campaign: newProjectionCampaignStore()}
	evt := event.Event{CampaignID: "camp-1", EntityID: "  ", Type: event.TypeParticipantUpdated, PayloadJSON: []byte(`{"fields":{"display_name":"X"}}`)}
	if err := applier.Apply(context.Background(), evt); err == nil {
		t.Fatal("expected error for missing entity id")
	}
}
...
func TestApplyParticipantUpdated_InvalidJSON(t *testing.T) {
	applier := Applier{Participant: newProjectionParticipantStore(), Campaign: newProjectionCampaignStore()}
	evt := event.Event{CampaignID: "camp-1", EntityID: "part-1", Type: event.TypeParticipantUpdated, PayloadJSON: []byte("{")}
	if err := applier.Apply(context.Background(), evt); err == nil {
		t.Fatal("expected error for invalid JSON")
	}
}
...
func TestApplyParticipantUpdated_InvalidRole(t *testing.T) {
	...
	campaignStore.campaigns["camp-1"] = campaign.Campaign{ID: "camp-1"}
	applier := Applier{Participant: participantStore, Campaign: campaignStore}
	payload := event.ParticipantUpdatedPayload{Fields: map[string]any{"role": "ALIEN"}}
	data, _ := json.Marshal(payload)
	evt := event.Event{CampaignID: "camp-1", EntityID: "part-1", Type: event.TypeParticipantUpdated, PayloadJSON: data}
	if err := applier.Apply(ctx, evt); err == nil {
...
func TestApplyParticipantUpdated_InvalidController(t *testing.T) {
	...
	campaignStore.campaigns["camp-1"] = campaign.Campaign{ID: "camp-1"}
	applier := Applier{Participant: participantStore, Campaign: campaignStore}
	payload := event.ParticipantUpdatedPayload{Fields: map[string]any{"controller": "ALIEN"}}
	data, _ := json.Marshal(payload)
	evt := event.Event{CampaignID: "camp-1", EntityID: "part-1", Type: event.TypeParticipantUpdated, PayloadJSON: data}
	if err := applier.Apply(ctx, evt); err == nil {
...
func TestApplyParticipantUpdated_InvalidAccess(t *testing.T) {
	...
	campaignStore.campaigns["camp-1"] = campaign.Campaign{ID: "camp-1"}
	applier := Applier{Participant: participantStore, Campaign: campaignStore}
	payload := event.ParticipantUpdatedPayload{Fields: map[string]any{"campaign_access": "ALIEN"}}
	data, _ := json.Marshal(payload)
	evt := event.Event{CampaignID: "camp-1", EntityID: "part-1", Type: event.TypeParticipantUpdated, PayloadJSON: data}
	if err := applier.Apply(ctx, evt); err == nil {
...
func TestApplyParticipantJoined_InvalidRole(t *testing.T) {
	applier := Applier{Participant: newProjectionParticipantStore(), Campaign: newProjectionCampaignStore()}
	payload := event.ParticipantJoinedPayload{DisplayName: "A", Role: "ALIEN", Controller: "HUMAN", CampaignAccess: "READ_ONLY"}
	data, _ := json.Marshal(payload)
	evt := event.Event{CampaignID: "camp-1", EntityID: "part-1", Type: event.TypeParticipantJoined, PayloadJSON: data}
	if err := applier.Apply(context.Background(), evt); err == nil {
		t.Fatal("expected error for invalid role")
...
func TestApplyParticipantJoined_InvalidController(t *testing.T) {
	applier := Applier{Participant: newProjectionParticipantStore(), Campaign: newProjectionCampaignStore()}
	payload := event.ParticipantJoinedPayload{DisplayName: "A", Role: "PLAYER", Controller: "ALIEN", CampaignAccess: "READ_ONLY"}
	data, _ := json.Marshal(payload)
	evt := event.Event{CampaignID: "camp-1", EntityID: "part-1", Type: event.TypeParticipantJoined, PayloadJSON: data}
	if err := applier.Apply(context.Background(), evt); err == nil {
		t.Fatal("expected error for invalid controller")
...
func TestApplyParticipantJoined_InvalidAccess(t *testing.T) {
	applier := Applier{Participant: newProjectionParticipantStore(), Campaign: newProjectionCampaignStore()}
	payload := event.ParticipantJoinedPayload{DisplayName: "A", Role: "PLAYER", Controller: "HUMAN", CampaignAccess: "ALIEN"}
	data, _ := json.Marshal(payload)
	evt := event.Event{CampaignID: "camp-1", EntityID: "part-1", Type: event.TypeParticipantJoined, PayloadJSON: data}
	if err := applier.Apply(context.Background(), evt); err == nil {
		t.Fatal("expected error for invalid access")
...
func TestApplyParticipantBound_WithClaimIndex(t *testing.T) {
	...
	claimStore := newFakeClaimIndexStore()
	applier := Applier{Participant: participantStore, Campaign: campaignStore, ClaimIndex: claimStore}
	payload := event.ParticipantBoundPayload{UserID: "u1"}
	data, _ := json.Marshal(payload)
	evt := event.Event{CampaignID: "camp-1", EntityID: "part-1", Type: event.TypeParticipantBound, PayloadJSON: data}
	if err := applier.Apply(ctx, evt); err != nil {
		t.Fatalf("apply: %v", err)
...
func TestApplyParticipantUnbound_WithClaimIndex(t *testing.T) {
	...
	claimStore := newFakeClaimIndexStore()
	applier := Applier{Participant: participantStore, Campaign: campaignStore, ClaimIndex: claimStore}
	payload := event.ParticipantUnboundPayload{UserID: "u1"}
	data, _ := json.Marshal(payload)
	evt := event.Event{CampaignID: "camp-1", EntityID: "part-1", Type: event.TypeParticipantUnbound, PayloadJSON: data}
	if err := applier.Apply(ctx, evt); err != nil {
		t.Fatalf("apply: %v", err)
