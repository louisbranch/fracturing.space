...
const (
	...
	CommandTypeCharacterControllerSet command.Type = "session.character_controller.set"
	...
	EventTypeCharacterControllerSet   event.Type   = "session.character_controller_set"
	...
	rejectionCodeSessionCharacterRequired            = "SESSION_CHARACTER_REQUIRED"
	rejectionCodeSessionCharacterControllerRequired  = "SESSION_CHARACTER_CONTROLLER_REQUIRED"
	rejectionCodeSessionCharacterControllerUnchanged = "SESSION_CHARACTER_CONTROLLER_UNCHANGED"
...
func RejectionCodes() []string {
	return []string{
		...
		rejectionCodeSessionCharacterRequired,
		rejectionCodeSessionCharacterControllerRequired,
		rejectionCodeSessionCharacterControllerUnchanged,
...
func Decide(state State, cmd command.Command, now func() time.Time) command.Decision {
	...
	case CommandTypeCharacterControllerSet:
		return decideCharacterControllerSet(state, cmd, now)
