...
const file_game_v1_character_proto_rawDesc = "" +
	...
	"\x04kind\x18\x03 \x01(\x0e2\x16.game.v1.CharacterKindR\x04kind\x12\x14\n" +
	"\x05notes\x18\x04 \x01(\tR\x05notes\"K\n" +
	"\x17CreateCharacterResponse\x120\n" +
	"\tcharacter\x18\x01 \x01(\v2\x12.game.v1.CharacterR\tcharacter\"\xee\x01\n" +
	...
	"\x04kind\x18\x04 \x01(\x0e2\x16.game.v1.CharacterKindR\x04kind\x122\n" +
	"\x05notes\x18\x05 \x01(\v2\x1c.google.protobuf.StringValueR\x05notes\"K\n" +
	"\x17UpdateCharacterResponse\x120\n" +
	"\tcharacter\x18\x01 \x01(\v2\x12.game.v1.CharacterR\tcharacter\"t\n" +
	"\x16DeleteCharacterRequest\x12\x1f\n" +
	"\vcampaign_id\x18\x01 \x01(\tR\n" +
	"campaignId\x12!\n" +
	"\fcharacter_id\x18\x02 \x01(\tR\vcharacterId\x12\x16\n" +
	"\x06reason\x18\x03 \x01(\tR\x06reason\"K\n" +
	"\x17DeleteCharacterResponse\x120\n" +
	"\tcharacter\x18\x01 \x01(\v2\x12.game.v1.CharacterR\tcharacter\"t\n" +
	...
	"\vcampaign_id\x18\x01 \x01(\tR\n" +
	"campaignId\x12!\n" +
	"\fcharacter_id\x18\x02 \x01(\tR\vcharacterId\"\xb1\x01\n" +
	"\x19GetCharacterSheetResponse\x120\n" +
	"\tcharacter\x18\x01 \x01(\v2\x12.game.v1.CharacterR\tcharacter\x123\n" +
	"\aprofile\x18\x02 \x01(\v2\x19.game.v1.CharacterProfileR\aprofile\x12-\n" +
	"\x05state\x18\x03 \x01(\v2\x17.game.v1.CharacterStateR\x05state\"\xca\x01\n" +
	...
	"\x14system_profile_patch\"T\n" +
	"\x1dPatchCharacterProfileResponse\x123\n" +
	"\aprofile\x18\x01 \x01(\v2\x19.game.v1.CharacterProfileR\aprofile\"\xbb\x01\n" +
	...
	"\x02PC\x10\x01\x12\a\n" +
	"\x03NPC\x10\x022\x87\x05\n" +
	"\x10CharacterService\x12T\n" +
	"\x0fCreateCharacter\x12\x1f.game.v1.CreateCharacterRequest\x1a .game.v1.CreateCharacterResponse\x12T\n" +
	"\x0fUpdateCharacter\x12\x1f.game.v1.UpdateCharacterRequest\x1a .game.v1.UpdateCharacterResponse\x12T\n" +
	"\x0fDeleteCharacter\x12\x1f.game.v1.DeleteCharacterRequest\x1a .game.v1.DeleteCharacterResponse\x12Q\n" +
	"\x0eListCharacters\x12\x1e.game.v1.ListCharactersRequest\x1a\x1f.game.v1.ListCharactersResponse\x12Z\n" +
	"\x11SetDefaultControl\x12!.game.v1.SetDefaultControlRequest\x1a\".game.v1.SetDefaultControlResponse\x12Z\n" +
	"\x11GetCharacterSheet\x12!.game.v1.GetCharacterSheetRequest\x1a\".game.v1.GetCharacterSheetResponse\x12f\n" +
	"\x15PatchCharacterProfile\x12%.game.v1.PatchCharacterProfileRequest\x1a&.game.v1.PatchCharacterProfileResponseBCZAgithub.com/louisbranch/fracturing.space/api/gen/go/game/v1;gamev1b\x06proto3"
