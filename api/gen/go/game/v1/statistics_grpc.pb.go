...
const (
	StatisticsService_GetGameStatistics_FullMethodName = "/game.v1.StatisticsService/GetGameStatistics"
)
...
//
// StatisticsService provides aggregate game statistics.
...
func (c *statisticsServiceClient) GetGameStatistics(ctx context.Context, in *GetGameStatisticsRequest, opts ...grpc.CallOption) (*GetGameStatisticsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetGameStatisticsResponse)
	err := c.cc.Invoke(ctx, StatisticsService_GetGameStatistics_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedStatisticsServiceServer) GetGameStatistics(context.Context, *GetGameStatisticsRequest) (*GetGameStatisticsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetGameStatistics not implemented")
}
...
func _StatisticsService_GetGameStatistics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetGameStatisticsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StatisticsServiceServer).GetGameStatistics(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StatisticsService_GetGameStatistics_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StatisticsServiceServer).GetGameStatistics(ctx, req.(*GetGameStatisticsRequest))
	}
...
var StatisticsService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "game.v1.StatisticsService",
	HandlerType: (*StatisticsServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetGameStatistics",
			Handler:    _StatisticsService_GetGameStatistics_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "game/v1/statistics.proto",
}
