...
const (
	InviteService_CreateInvite_FullMethodName                 = "/invite.v1.InviteService/CreateInvite"
	InviteService_ClaimInvite_FullMethodName                  = "/invite.v1.InviteService/ClaimInvite"
	InviteService_DeclineInvite_FullMethodName                = "/invite.v1.InviteService/DeclineInvite"
	InviteService_RevokeInvite_FullMethodName                 = "/invite.v1.InviteService/RevokeInvite"
	InviteService_GetInvite_FullMethodName                    = "/invite.v1.InviteService/GetInvite"
	InviteService_GetPublicInvite_FullMethodName              = "/invite.v1.InviteService/GetPublicInvite"
	InviteService_ListInvites_FullMethodName                  = "/invite.v1.InviteService/ListInvites"
	InviteService_ListPendingInvites_FullMethodName           = "/invite.v1.InviteService/ListPendingInvites"
	InviteService_ListPendingInvitesForUser_FullMethodName    = "/invite.v1.InviteService/ListPendingInvitesForUser"
	InviteService_LeaseIntegrationOutboxEvents_FullMethodName = "/invite.v1.InviteService/LeaseIntegrationOutboxEvents"
	InviteService_AckIntegrationOutboxEvent_FullMethodName    = "/invite.v1.InviteService/AckIntegrationOutboxEvent"
)
...
func (c *inviteServiceClient) LeaseIntegrationOutboxEvents(ctx context.Context, in *LeaseIntegrationOutboxEventsRequest, opts ...grpc.CallOption) (*LeaseIntegrationOutboxEventsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LeaseIntegrationOutboxEventsResponse)
	err := c.cc.Invoke(ctx, InviteService_LeaseIntegrationOutboxEvents_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *inviteServiceClient) AckIntegrationOutboxEvent(ctx context.Context, in *AckIntegrationOutboxEventRequest, opts ...grpc.CallOption) (*AckIntegrationOutboxEventResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AckIntegrationOutboxEventResponse)
	err := c.cc.Invoke(ctx, InviteService_AckIntegrationOutboxEvent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedInviteServiceServer) ListPendingInvites(context.Context, *ListPendingInvitesRequest) (*ListPendingInvitesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListPendingInvites not implemented")
}
func (UnimplementedInviteServiceServer) ListPendingInvitesForUser(context.Context, *ListPendingInvitesForUserRequest) (*ListPendingInvitesForUserResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListPendingInvitesForUser not implemented")
}
func (UnimplementedInviteServiceServer) LeaseIntegrationOutboxEvents(context.Context, *LeaseIntegrationOutboxEventsRequest) (*LeaseIntegrationOutboxEventsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method LeaseIntegrationOutboxEvents not implemented")
}
func (UnimplementedInviteServiceServer) AckIntegrationOutboxEvent(context.Context, *AckIntegrationOutboxEventRequest) (*AckIntegrationOutboxEventResponse, error) {
...
func _InviteService_LeaseIntegrationOutboxEvents_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LeaseIntegrationOutboxEventsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InviteServiceServer).LeaseIntegrationOutboxEvents(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: InviteService_LeaseIntegrationOutboxEvents_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InviteServiceServer).LeaseIntegrationOutboxEvents(ctx, req.(*LeaseIntegrationOutboxEventsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _InviteService_AckIntegrationOutboxEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AckIntegrationOutboxEventRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InviteServiceServer).AckIntegrationOutboxEvent(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: InviteService_AckIntegrationOutboxEvent_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InviteServiceServer).AckIntegrationOutboxEvent(ctx, req.(*AckIntegrationOutboxEventRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var InviteService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _InviteService_LeaseIntegrationOutboxEvents_Handler,
		},
		{
			MethodName: "AckIntegrationOutboxEvent",
			Handler:    _InviteService_AckIntegrationOutboxEvent_Handler,
		},
	},
