...
type Campaign struct {
	...
	Status CampaignStatus `protobuf:"varint,4,opt,name=status,proto3,enum=campaign.v1.CampaignStatus" json:"status,omitempty"`
	GmMode GmMode         `protobuf:"varint,5,opt,name=gm_mode,json=gmMode,proto3,enum=campaign.v1.GmMode" json:"gm_mode,omitempty"`
...
const file_campaign_v1_campaign_proto_rawDesc = "" +
	...
	"\x06system\x18\x03 \x01(\x0e2\x15.common.v1.GameSystemR\x06system\x123\n" +
	"\x06status\x18\x04 \x01(\x0e2\x1b.campaign.v1.CampaignStatusR\x06status\x12,\n" +
	"\agm_mode\x18\x05 \x01(\x0e2\x13.campaign.v1.GmModeR\x06gmMode\x12+\n" +
	...
	"\bcampaign\x18\x01 \x01(\v2\x15.campaign.v1.CampaignR\bcampaign\"5\n" +
	"\x12EndCampaignRequest\x12\x1f\n" +
	"\vcampaign_id\x18\x01 \x01(\tR\n" +
	"campaignId\"H\n" +
	"\x13EndCampaignResponse\x121\n" +
	"\bcampaign\x18\x01 \x01(\v2\x15.campaign.v1.CampaignR\bcampaign\"9\n" +
	"\x16ArchiveCampaignRequest\x12\x1f\n" +
	"\vcampaign_id\x18\x01 \x01(\tR\n" +
	"campaignId\"L\n" +
	"\x17ArchiveCampaignResponse\x121\n" +
	"\bcampaign\x18\x01 \x01(\v2\x15.campaign.v1.CampaignR\bcampaign\"9\n" +
	"\x16RestoreCampaignRequest\x12\x1f\n" +
	"\vcampaign_id\x18\x01 \x01(\tR\n" +
	"campaignId\"L\n" +
	"\x17RestoreCampaignResponse\x121\n" +
	"\bcampaign\x18\x01 \x01(\v2\x15.campaign.v1.CampaignR\bcampaign*e\n" +
	...
	"\vGetCampaign\x12\x1f.campaign.v1.GetCampaignRequest\x1a .campaign.v1.GetCampaignResponse\x12P\n" +
	"\vEndCampaign\x12\x1f.campaign.v1.EndCampaignRequest\x1a .campaign.v1.EndCampaignResponse\x12\\\n" +
	"\x0fArchiveCampaign\x12#.campaign.v1.ArchiveCampaignRequest\x1a$.campaign.v1.ArchiveCampaignResponse\x12\\\n" +
	"\x0fRestoreCampaign\x12#.campaign.v1.RestoreCampaignRequest\x1a$.campaign.v1.RestoreCampaignResponseBKZIgithub.com/louisbranch/fracturing.space/api/gen/go/campaign/v1;campaignv1b\x06proto3"
...
var file_campaign_v1_campaign_proto_goTypes = []any{
	...
	(*EndCampaignRequest)(nil),      // 9: campaign.v1.EndCampaignRequest
	(*EndCampaignResponse)(nil),     // 10: campaign.v1.EndCampaignResponse
	(*ArchiveCampaignRequest)(nil),  // 11: campaign.v1.ArchiveCampaignRequest
	(*ArchiveCampaignResponse)(nil), // 12: campaign.v1.ArchiveCampaignResponse
	(*RestoreCampaignRequest)(nil),  // 13: campaign.v1.RestoreCampaignRequest
...
var file_campaign_v1_campaign_proto_depIdxs = []int32{
	...
	1,  // 2: campaign.v1.Campaign.gm_mode:type_name -> campaign.v1.GmMode
	16, // 3: campaign.v1.Campaign.created_at:type_name -> google.protobuf.Timestamp
	16, // 4: campaign.v1.Campaign.last_activity_at:type_name -> google.protobuf.Timestamp
	16, // 5: campaign.v1.Campaign.updated_at:type_name -> google.protobuf.Timestamp
	16, // 6: campaign.v1.Campaign.completed_at:type_name -> google.protobuf.Timestamp
	16, // 7: campaign.v1.Campaign.archived_at:type_name -> google.protobuf.Timestamp
