...
const (
	CampaignService_CreateCampaign_FullMethodName  = "/state.v1.CampaignService/CreateCampaign"
	CampaignService_ListCampaigns_FullMethodName   = "/state.v1.CampaignService/ListCampaigns"
	CampaignService_GetCampaign_FullMethodName     = "/state.v1.CampaignService/GetCampaign"
	CampaignService_EndCampaign_FullMethodName     = "/state.v1.CampaignService/EndCampaign"
	CampaignService_ArchiveCampaign_FullMethodName = "/state.v1.CampaignService/ArchiveCampaign"
	CampaignService_RestoreCampaign_FullMethodName = "/state.v1.CampaignService/RestoreCampaign"
)
...
func (UnimplementedCampaignServiceServer) EndCampaign(context.Context, *EndCampaignRequest) (*EndCampaignResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method EndCampaign not implemented")
}
...
func (UnimplementedCampaignServiceServer) RestoreCampaign(context.Context, *RestoreCampaignRequest) (*RestoreCampaignResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RestoreCampaign not implemented")
}
...
var CampaignService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "state.v1.CampaignService",
	...
	Metadata: "state/v1/campaign.proto",
}
