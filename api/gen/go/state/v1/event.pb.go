...
func (x *ListEventsRequest) Reset() {
	*x = ListEventsRequest{}
	mi := &file_state_v1_event_proto_msgTypes[0]
...
func (*ListEventsRequest) Descriptor() ([]byte, []int) {
	return file_state_v1_event_proto_rawDescGZIP(), []int{0}
}
...
func (x *ListEventsResponse) Reset() {
	*x = ListEventsResponse{}
	mi := &file_state_v1_event_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListEventsResponse) Descriptor() ([]byte, []int) {
	return file_state_v1_event_proto_rawDescGZIP(), []int{1}
}
...
func (x *AppendEventRequest) Reset() {
	*x = AppendEventRequest{}
	mi := &file_state_v1_event_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AppendEventRequest) Descriptor() ([]byte, []int) {
	return file_state_v1_event_proto_rawDescGZIP(), []int{2}
}
...
func (x *AppendEventResponse) Reset() {
	*x = AppendEventResponse{}
	mi := &file_state_v1_event_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AppendEventResponse) Descriptor() ([]byte, []int) {
	return file_state_v1_event_proto_rawDescGZIP(), []int{3}
}
...
func (x *Event) Reset() {
	*x = Event{}
	mi := &file_state_v1_event_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Event) Descriptor() ([]byte, []int) {
	return file_state_v1_event_proto_rawDescGZIP(), []int{4}
}
...
var File_state_v1_event_proto protoreflect.FileDescriptor

const file_state_v1_event_proto_rawDesc = "" +
	"\n" +
	"\x14state/v1/event.proto\x12\bstate.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa3\x01\n" +
	...
	"\x06events\x18\x01 \x03(\v2\x0f.state.v1.EventR\x06events\x12&\n" +
	...
	"\x05event\x18\x01 \x01(\v2\x0f.state.v1.EventR\x05event\"\x8c\x03\n" +
	"\x05Event\x12\x1f\n" +
	"\vcampaign_id\x18\x01 \x01(\tR\n" +
	"campaignId\x12\x10\n" +
	...
	"\fpayload_json\x18\r \x01(\fR\vpayloadJson2\xa3\x01\n" +
	"\fEventService\x12J\n" +
	"\vAppendEvent\x12\x1c.state.v1.AppendEventRequest\x1a\x1d.state.v1.AppendEventResponse\x12G\n" +
	"\n" +
	"ListEvents\x12\x1b.state.v1.ListEventsRequest\x1a\x1c.state.v1.ListEventsResponseBEZCgithub.com/louisbranch/fracturing.space/api/gen/go/state/v1;statev1b\x06proto3"

var (
	file_state_v1_event_proto_rawDescOnce sync.Once
	file_state_v1_event_proto_rawDescData []byte
)

func file_state_v1_event_proto_rawDescGZIP() []byte {
	file_state_v1_event_proto_rawDescOnce.Do(func() {
		file_state_v1_event_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_state_v1_event_proto_rawDesc), len(file_state_v1_event_proto_rawDesc)))
	})
	return file_state_v1_event_proto_rawDescData
}

var file_state_v1_event_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_state_v1_event_proto_goTypes = []any{
	(*ListEventsRequest)(nil),     // 0: state.v1.ListEventsRequest
	(*ListEventsResponse)(nil),    // 1: state.v1.ListEventsResponse
	(*AppendEventRequest)(nil),    // 2: state.v1.AppendEventRequest
	(*AppendEventResponse)(nil),   // 3: state.v1.AppendEventResponse
	(*Event)(nil),                 // 4: state.v1.Event
	(*timestamppb.Timestamp)(nil), // 5: google.protobuf.Timestamp
}
var file_state_v1_event_proto_depIdxs = []int32{
	4, // 0: state.v1.ListEventsResponse.events:type_name -> state.v1.Event
	4, // 1: state.v1.AppendEventResponse.event:type_name -> state.v1.Event
	5, // 2: state.v1.Event.ts:type_name -> google.protobuf.Timestamp
	2, // 3: state.v1.EventService.AppendEvent:input_type -> state.v1.AppendEventRequest
	0, // 4: state.v1.EventService.ListEvents:input_type -> state.v1.ListEventsRequest
	3, // 5: state.v1.EventService.AppendEvent:output_type -> state.v1.AppendEventResponse
	1, // 6: state.v1.EventService.ListEvents:output_type -> state.v1.ListEventsResponse
...
func init() { file_state_v1_event_proto_init() }
func file_state_v1_event_proto_init() {
	if File_state_v1_event_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_state_v1_event_proto_rawDesc), len(file_state_v1_event_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_state_v1_event_proto_goTypes,
		DependencyIndexes: file_state_v1_event_proto_depIdxs,
		MessageInfos:      file_state_v1_event_proto_msgTypes,
	}.Build()
	File_state_v1_event_proto = out.File
	file_state_v1_event_proto_goTypes = nil
	file_state_v1_event_proto_depIdxs = nil
}
