...
func (InviteStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_state_v1_invite_proto_enumTypes[0].Descriptor()
}

func (InviteStatus) Type() protoreflect.EnumType {
	return &file_state_v1_invite_proto_enumTypes[0]
}
...
func (InviteStatus) EnumDescriptor() ([]byte, []int) {
	return file_state_v1_invite_proto_rawDescGZIP(), []int{0}
}
...
type Invite struct {
	...
	Status                 InviteStatus           `protobuf:"varint,4,opt,name=status,proto3,enum=state.v1.InviteStatus" json:"status,omitempty"`
...
func (x *Invite) Reset() {
	*x = Invite{}
	mi := &file_state_v1_invite_proto_msgTypes[0]
...
func (x *CreateInviteRequest) Reset() {
	*x = CreateInviteRequest{}
	mi := &file_state_v1_invite_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateInviteRequest) Descriptor() ([]byte, []int) {
	return file_state_v1_invite_proto_rawDescGZIP(), []int{1}
}
...
func (x *CreateInviteResponse) Reset() {
	*x = CreateInviteResponse{}
	mi := &file_state_v1_invite_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateInviteResponse) Descriptor() ([]byte, []int) {
	return file_state_v1_invite_proto_rawDescGZIP(), []int{2}
}
...
func (x *GetInviteRequest) Reset() {
	*x = GetInviteRequest{}
	mi := &file_state_v1_invite_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetInviteRequest) Descriptor() ([]byte, []int) {
	return file_state_v1_invite_proto_rawDescGZIP(), []int{3}
}
...
func (x *GetInviteResponse) Reset() {
	*x = GetInviteResponse{}
	mi := &file_state_v1_invite_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetInviteResponse) Descriptor() ([]byte, []int) {
	return file_state_v1_invite_proto_rawDescGZIP(), []int{4}
}
...
func (x *ListInvitesRequest) Reset() {
	*x = ListInvitesRequest{}
	mi := &file_state_v1_invite_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListInvitesRequest) Descriptor() ([]byte, []int) {
	return file_state_v1_invite_proto_rawDescGZIP(), []int{5}
}
...
func (x *ListInvitesResponse) Reset() {
	*x = ListInvitesResponse{}
	mi := &file_state_v1_invite_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListInvitesResponse) Descriptor() ([]byte, []int) {
	return file_state_v1_invite_proto_rawDescGZIP(), []int{6}
}
...
func (x *RevokeInviteRequest) Reset() {
	*x = RevokeInviteRequest{}
	mi := &file_state_v1_invite_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RevokeInviteRequest) Descriptor() ([]byte, []int) {
	return file_state_v1_invite_proto_rawDescGZIP(), []int{7}
}
...
func (x *RevokeInviteResponse) Reset() {
	*x = RevokeInviteResponse{}
	mi := &file_state_v1_invite_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RevokeInviteResponse) Descriptor() ([]byte, []int) {
	return file_state_v1_invite_proto_rawDescGZIP(), []int{8}
}
...
var File_state_v1_invite_proto protoreflect.FileDescriptor

const file_state_v1_invite_proto_rawDesc = "" +
	"\n" +
	"\x15state/v1/invite.proto\x12\bstate.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xc1\x02\n" +
	"\x06Invite\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1f\n" +
	"\vcampaign_id\x18\x02 \x01(\tR\n" +
	"campaignId\x12%\n" +
	"\x0eparticipant_id\x18\x03 \x01(\tR\rparticipantId\x12.\n" +
	"\x06status\x18\x04 \x01(\x0e2\x16.state.v1.InviteStatusR\x06status\x129\n" +
	...
	"\x06invite\x18\x01 \x01(\v2\x10.state.v1.InviteR\x06invite\"/\n" +
	"\x10GetInviteRequest\x12\x1b\n" +
	"\tinvite_id\x18\x01 \x01(\tR\binviteId\"=\n" +
	"\x11GetInviteResponse\x12(\n" +
	"\x06invite\x18\x01 \x01(\v2\x10.state.v1.InviteR\x06invite\"q\n" +
	...
	"\ainvites\x18\x01 \x03(\v2\x10.state.v1.InviteR\ainvites\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"2\n" +
	"\x13RevokeInviteRequest\x12\x1b\n" +
	"\tinvite_id\x18\x01 \x01(\tR\binviteId\"@\n" +
	"\x14RevokeInviteResponse\x12(\n" +
	"\x06invite\x18\x01 \x01(\v2\x10.state.v1.InviteR\x06invite*T\n" +
	"\fInviteStatus\x12\x1d\n" +
	"\x19INVITE_STATUS_UNSPECIFIED\x10\x00\x12\v\n" +
	"\aPENDING\x10\x01\x12\v\n" +
	"\aCLAIMED\x10\x02\x12\v\n" +
	"\aREVOKED\x10\x032\xbf\x02\n" +
	"\rInviteService\x12M\n" +
	"\fCreateInvite\x12\x1d.state.v1.CreateInviteRequest\x1a\x1e.state.v1.CreateInviteResponse\x12D\n" +
	"\tGetInvite\x12\x1a.state.v1.GetInviteRequest\x1a\x1b.state.v1.GetInviteResponse\x12J\n" +
	"\vListInvites\x12\x1c.state.v1.ListInvitesRequest\x1a\x1d.state.v1.ListInvitesResponse\x12M\n" +
	"\fRevokeInvite\x12\x1d.state.v1.RevokeInviteRequest\x1a\x1e.state.v1.RevokeInviteResponseBEZCgithub.com/louisbranch/fracturing.space/api/gen/go/state/v1;statev1b\x06proto3"

var (
	file_state_v1_invite_proto_rawDescOnce sync.Once
	file_state_v1_invite_proto_rawDescData []byte
)

func file_state_v1_invite_proto_rawDescGZIP() []byte {
	file_state_v1_invite_proto_rawDescOnce.Do(func() {
		file_state_v1_invite_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_state_v1_invite_proto_rawDesc), len(file_state_v1_invite_proto_rawDesc)))
	})
	return file_state_v1_invite_proto_rawDescData
}

var file_state_v1_invite_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_state_v1_invite_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_state_v1_invite_proto_goTypes = []any{
	(InviteStatus)(0),             // 0: state.v1.InviteStatus
	(*Invite)(nil),                // 1: state.v1.Invite
	(*CreateInviteRequest)(nil),   // 2: state.v1.CreateInviteRequest
	(*CreateInviteResponse)(nil),  // 3: state.v1.CreateInviteResponse
	(*GetInviteRequest)(nil),      // 4: state.v1.GetInviteRequest
	(*GetInviteResponse)(nil),     // 5: state.v1.GetInviteResponse
	(*ListInvitesRequest)(nil),    // 6: state.v1.ListInvitesRequest
	(*ListInvitesResponse)(nil),   // 7: state.v1.ListInvitesResponse
	(*RevokeInviteRequest)(nil),   // 8: state.v1.RevokeInviteRequest
	(*RevokeInviteResponse)(nil),  // 9: state.v1.RevokeInviteResponse
	(*timestamppb.Timestamp)(nil), // 10: google.protobuf.Timestamp
}
var file_state_v1_invite_proto_depIdxs = []int32{
	0,  // 0: state.v1.Invite.status:type_name -> state.v1.InviteStatus
	10, // 1: state.v1.Invite.created_at:type_name -> google.protobuf.Timestamp
	10, // 2: state.v1.Invite.updated_at:type_name -> google.protobuf.Timestamp
	1,  // 3: state.v1.CreateInviteResponse.invite:type_name -> state.v1.Invite
	1,  // 4: state.v1.GetInviteResponse.invite:type_name -> state.v1.Invite
	1,  // 5: state.v1.ListInvitesResponse.invites:type_name -> state.v1.Invite
	1,  // 6: state.v1.RevokeInviteResponse.invite:type_name -> state.v1.Invite
	2,  // 7: state.v1.InviteService.CreateInvite:input_type -> state.v1.CreateInviteRequest
	4,  // 8: state.v1.InviteService.GetInvite:input_type -> state.v1.GetInviteRequest
	6,  // 9: state.v1.InviteService.ListInvites:input_type -> state.v1.ListInvitesRequest
	8,  // 10: state.v1.InviteService.RevokeInvite:input_type -> state.v1.RevokeInviteRequest
	3,  // 11: state.v1.InviteService.CreateInvite:output_type -> state.v1.CreateInviteResponse
	5,  // 12: state.v1.InviteService.GetInvite:output_type -> state.v1.GetInviteResponse
	7,  // 13: state.v1.InviteService.ListInvites:output_type -> state.v1.ListInvitesResponse
	9,  // 14: state.v1.InviteService.RevokeInvite:output_type -> state.v1.RevokeInviteResponse
...
func init() { file_state_v1_invite_proto_init() }
func file_state_v1_invite_proto_init() {
	if File_state_v1_invite_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_state_v1_invite_proto_rawDesc), len(file_state_v1_invite_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_state_v1_invite_proto_goTypes,
		DependencyIndexes: file_state_v1_invite_proto_depIdxs,
		EnumInfos:         file_state_v1_invite_proto_enumTypes,
		MessageInfos:      file_state_v1_invite_proto_msgTypes,
	}.Build()
	File_state_v1_invite_proto = out.File
	file_state_v1_invite_proto_goTypes = nil
	file_state_v1_invite_proto_depIdxs = nil
}
