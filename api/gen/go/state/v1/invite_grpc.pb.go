...
const (
	InviteService_CreateInvite_FullMethodName = "/state.v1.InviteService/CreateInvite"
	InviteService_GetInvite_FullMethodName    = "/state.v1.InviteService/GetInvite"
	InviteService_ListInvites_FullMethodName  = "/state.v1.InviteService/ListInvites"
	InviteService_RevokeInvite_FullMethodName = "/state.v1.InviteService/RevokeInvite"
)
...
var InviteService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "state.v1.InviteService",
	...
	Metadata: "state/v1/invite.proto",
}
