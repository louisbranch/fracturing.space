...
const (
	CharacterService_CreateCharacter_FullMethodName       = "/state.v1.CharacterService/CreateCharacter"
	CharacterService_UpdateCharacter_FullMethodName       = "/state.v1.CharacterService/UpdateCharacter"
	CharacterService_DeleteCharacter_FullMethodName       = "/state.v1.CharacterService/DeleteCharacter"
	CharacterService_ListCharacters_FullMethodName        = "/state.v1.CharacterService/ListCharacters"
	CharacterService_SetDefaultControl_FullMethodName     = "/state.v1.CharacterService/SetDefaultControl"
	CharacterService_GetCharacterSheet_FullMethodName     = "/state.v1.CharacterService/GetCharacterSheet"
	CharacterService_PatchCharacterProfile_FullMethodName = "/state.v1.CharacterService/PatchCharacterProfile"
)
...
var CharacterService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "state.v1.CharacterService",
	...
	Metadata: "state/v1/character.proto",
}
