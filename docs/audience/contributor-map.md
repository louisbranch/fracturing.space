...
| Add Daggerheart domain rules/mechanics | `internal/services/game/domain/systems/daggerheart/` |
| Add admin page/route or adjust admin rendering | `internal/services/admin/handler_*.go`, `internal/services/admin/templates/` |
| Add/update MCP campaign tools/resources | `internal/services/mcp/domain/campaign_*.go` |
