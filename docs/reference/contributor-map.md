...
| Add/update play SPA UI, system-specific game views, or websocket/bootstrap client behavior | `internal/services/play/ui/src/`, `internal/services/play/ui/src/features/`, `internal/services/play/ui/src/systems/` |
