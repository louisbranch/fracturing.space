...
- Emitters:
  - `internal/services/game/domain/scene/decider_gm_output.go:47`
...
- Emitters:
  - `internal/services/game/domain/scene/decider_player_phase.go:236`
...
- Emitters:
  - `internal/services/game/domain/scene/decider_player_phase.go:134`
...
- Emitters:
  - `internal/services/game/domain/scene/decider_player_phase.go:181`
...
- Emitters:
  - `internal/services/game/domain/scene/decider_player_phase.go:73`
...
- Emitters:
  - `internal/services/game/domain/scene/decider_player_phase.go:218`
...
- Emitters:
  - `internal/services/game/domain/scene/decider_player_phase.go:171`
...
- Emitters:
  - `internal/services/game/domain/session/decider_ooc.go:28`
...
- Emitters:
  - `internal/services/game/domain/session/decider_ooc.go:67`
...
- Emitters:
  - `internal/services/game/domain/session/decider_ooc.go:121`
...
- Emitters:
  - `internal/services/game/domain/session/decider_ooc.go:94`
...
- Emitters:
  - `internal/services/game/domain/session/decider_ooc.go:141`
