...
- Payload: `AITurnClearedPayload` (`internal/services/game/domain/session/payload.go:122`)
- Fields:
...
- Payload: `AITurnFailedPayload` (`internal/services/game/domain/session/payload.go:115`)
- Fields:
...
- Payload: `AITurnQueuedPayload` (`internal/services/game/domain/session/payload.go:99`)
- Fields:
...
- Payload: `AITurnRunningPayload` (`internal/services/game/domain/session/payload.go:109`)
- Fields:
...
- Payload: `CharacterControllerSetPayload` (`internal/services/game/domain/session/payload.go:49`)
- Fields:
...
- Payload: `GMAuthoritySetPayload` (`internal/services/game/domain/session/payload.go:42`)
- Fields:
...
- Payload: `OOCClosedPayload` (`internal/services/game/domain/session/payload.go:86`)
- Fields:
...
- Payload: `OOCOpenedPayload` (`internal/services/game/domain/session/payload.go:56`)
- Fields:
...
- Payload: `OOCPostedPayload` (`internal/services/game/domain/session/payload.go:66`)
- Fields:
...
- Payload: `OOCReadyClearedPayload` (`internal/services/game/domain/session/payload.go:80`)
- Fields:
...
- Payload: `OOCReadyMarkedPayload` (`internal/services/game/domain/session/payload.go:74`)
- Fields:
...
- Payload: `OOCResolvedPayload` (`internal/services/game/domain/session/payload.go:93`)
- Fields:
...
- Payload: `SceneActivatedPayload` (`internal/services/game/domain/session/payload.go:36`)
- Fields:
...
- Payload: `SpotlightClearedPayload` (`internal/services/game/domain/session/payload.go:31`)
- Fields:
...
- Payload: `SpotlightSetPayload` (`internal/services/game/domain/session/payload.go:25`)
- Fields:
