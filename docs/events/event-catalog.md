...
- Payload: `OOCClosedPayload` (`internal/services/game/domain/session/payload.go:70`)
- Fields:
...
- Payload: `OOCOpenedPayload` (`internal/services/game/domain/session/payload.go:40`)
- Fields:
...
- Payload: `OOCResolvedPayload` (`internal/services/game/domain/session/payload.go:77`)
- Fields:
...
- Payload: `SceneActivatedPayload` (`internal/services/game/domain/session/payload.go:28`)
- Fields:
