...
- `campaign.created`
  ...
  - Applier: `internal/services/game/projection/applier.go:66`
- `campaign.forked`
  - Emitters: `internal/services/game/api/grpc/game/fork_service.go:169`
  - Applier: `internal/services/game/projection/applier.go:108`
- `campaign.updated`
...
- `action.damage_applied`
  ...
  - Applier: `internal/services/game/domain/systems/daggerheart/adapter.go`
- `action.rest_taken`
